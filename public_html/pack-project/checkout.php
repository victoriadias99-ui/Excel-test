        ...
        <div class="container">
            <div class="row">
                <div class="col-md-4  mr-auto order-2 order-md-1">
                    <img class="img-fluid d-block" src="img/6.jpg">
                </div>
                <div class="px-md-5 p-3 d-flex flex-column align-items-start justify-content-center col-md-7 order-1 order-md-2" style="">
                    <h3 class="mb-3" style="font-family: montserrat_bold">Dominá a fondo esta herramienta y adquirí un conocimiento <span class="bg-success text-white px-2">imprescindible</span> en la actualidad
                    </h3>
            ...
            <div class="row">
                <div class="col-md-6 order-md-2 px-0 px-md-4" style="padding: 80px 20px 20px;">
                    ...
                    <div class=" col-md-12 mt-5" style="">
                        <div class=" mb-0">
                            <p>"Muy buen docente! Me llevó mas tiempo de lo esperado porque lo seguí con mi compu al pie de la letra. Aprendí muchísimo! Gracias profe"</p>
                    ...
                    <div class=" col-md-12 mt-5" style="">
                        <div class=" mb-0">
                            <p>"Muy bueno el curso.Tiene la gran ventaja de hacerlo en el tiempo que quieras y los horarios que quieras.Lo recomiendo"</p>
                            <div class="rating-user d-inline">
                                <i class="fa fa-star"></i>
                                <i class="fa fa-star"></i>
                                <i class="fa fa-star"></i>
                    ...
                    <div class=" col-md-12 mt-5" style="">
                        <div class=" mb-0">
                            <p>"Excelente el método y las explicaciones, muy practico, muy recomendable."</p>
                            <div class="rating-user d-inline">
                                <i class="fa fa-star"></i>
                                <i class="fa fa-star"></i>
                                <i class="fa fa-star"></i>
                            ...
                            <div class="blockquote-footer">
                                <b>Francisco Pancho Chazarreta</b>
                            </div>
                        </div>
                    </div>
                ...
                <div class="order-md-2 border rounded bg-light my-5 py-5 px-md-4 col-md-5" style="">
                    <h4 class="d-flex justify-content-between mb-3"> <span class="text-muted"><b>Tu Carrito</b> <i
...
<?php
    ...
    echo "</pre>";
                    ...
                    <ul class="list-group mt-4">
                        <li class="list-group-item d-flex justify-content-between">
                            <div>
                                <h6 class="my-0"><b>MS Project Pack</b></h6> <small class="text-muted">Acceso de
                                    por vida</small>
                            </div> <span class="text-muted"><?= $precioCurso ?></span>
                        </li>
                        ...
                        <?php
                            foreach ($data['pack'] as $c => $item) {
                                ...
                                <li class="list-group-item d-flex justify-content-between" id="item_<?= $item['ID_ABRE_PACK'] ?>" style="">
                                    ...
                                    </div> <span class="text-muted"><?= $simbolo . ' ' . convertirPrecio($precioItem, $moneda) . ' ' . $moneda ?></span>
                                </li>
                                <?php
                            }
                            ?>
                    ...
                    <hr>
                    <p class="text-left mt-2"><i class="fas fa-lock" style="color:green;"></i> Garantía de Satisfacción: Estamos tan seguros de que el curso te va a encantar que si en los primeros 7 dias no estás conforme, te devolvemos el dinero. Probalo, y si no estas satisfecho/a
                        te vamos a devolver el 100% de tu compra sin hacer preguntas. ¡Tenés todas las de ganar adquiriendo el curso hoy!
                        <p>
                            <img class="img-fluid d-block mx-auto mt-4 mb-3" src="../a-img/flecha.png">
    ...
    <div class="row mt-5 mx-auto" id="ch">
        <div class="col-4">
            <img class="img-fluid d-block mx-auto" src="img/badge1.jpg" draggable="true">
            <p class="pi-draggable text-center" draggable="true">Protegesmos tu privacidad</p>
        </div>
        <div class="col-4">
            <img class="img-fluid d-block mx-auto" src="img/badge2.jpg">
            <p class="pi-draggable text-center" draggable="true">Tus datos festán seguros</p>
        </div>
        <div class="col-4">
            <img class="img-fluid d-block mx-auto" src="img/badge3.jpg">
            <p class="pi-draggable text-center">Garantía de satisfacción 100%</p>
    ...
    <div class="py-5 text-center">
        <div class="container">
            ...
            <div class="row text-center">
                ...
                <div class="col-md-4 text-center">
                    <a class="" href="https://api.whatsapp.com/send?phone=5491168787291&amp;text=Hola!%20Te%20escribo%20por%20el%20curso%20de%20Pack%20Project">
                        <img class="img-fluid d-block  mx-auto" src="img/whatsapp.jpg"> </a>
                </div>
                <div class="col-md-4 text-center">
                </div>
            </div>
...
?>
            ...
            <script src="../a-libraries/js/checkout_.js?t=1"></script>
</body>
