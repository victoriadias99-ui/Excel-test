...
<html>
    ...
    <body style="font-family: 'Raleway Regular';">
        ...
        <div class="pt-5">
            <div class="container">
                <div class="row">
                    <div class="col-md-4  mr-auto order-2 order-md-1"> <img class="img-fluid d-block" src="/plantillas/finanzas/assets/img/finanzas.png"> </div>
                    <div class="px-md-5 p-3 d-flex flex-column align-items-start justify-content-center col-md-7 order-1 order-md-2" style="">
                        <h1 class="font-weight-bold">Aprende Excel - Plantillas de Finanzas</h1>
            ...
            <div class="container  px-0 px-md-4" style="">
                <div class="row p-3">
                    <div class="col-md-6 order-md-2 px-0 px-md-4" style="padding: 80px 20px 20px;">
                        ...
                        <p class="mb-3   mt-4"> Al abonar te vamos a enviar el link para que descargues las plantillas en tu PC, notebook, tablet o celular. ¡Es muy sencillo! </p>
                        <hr>

                        <div class=" col-md-12 mt-5" style="">
                            <div class=" mb-0">
                                <p>"Muy satisfecha, excelente las plantillas"</p>
                        ...
                        <div class=" col-md-12 mt-5" style="">
                            <div class=" mb-0">
                                <p>"Recomiendo 100% , me facilitaron muchísimo el trabajo diario."</p>
                                <div class="rating-user d-inline">
                                    <i class="fa fa-star"></i>
                                    <i class="fa fa-star"></i>
                                    <i class="fa fa-star"></i>
                            ...
                            </div><h4 class="mt-3 pb-2"><b> ¿Por qué la gente nos elige? </b></h4>
                            <ul class="lead">
                                <li> <i class="fas fa-check-square " style="color:#009045;"></i> Califiacion 4.9/5</li>
                                <li><i class="fas fa-check-square " style="color:#009045;"></i> Soporte 24/7</li>
                            </ul>
                        </div>
                    ...
                    <div class="order-md-2 border rounded bg-light my-5 py-5 px-md-4 col-md-5" style="">
                        ...
                        <ul class="list-group">
                            <li class="list-group-item d-flex justify-content-between">
                                <div>
                                    <h6 class="my-0"><b>Pack de plantillas de finanzas</b></h6> <small class="text-muted">Acceso de por vida</small>
                        ...
                        <div class="order-md-2 mx-3" style="">
                            <div class="row border rounded py-4 bg-white">
                                <h4 class="mx-auto mt-3 pb-3 text-center">¿Dónde querés recibir las plantillas?</h4>
            ...
            <div class="py-5 text-center text-dark mt-5">
                ...
                <div class="container">
                    ...
                    <div class="row text-center">
                        ...
                        <div class="col-md-4 text-center">
                            <a class="" href="https://api.whatsapp.com/send?phone=5491168787291&amp;text=Hola!%20Te%20escribo%20por%20las%20plantillas" target="_blank"> <img class="img-fluid d-block  mx-auto" src="../../n-img/whatsapp_.jpg"> </a>
                        </div>
                        <div class="col-md-4 text-center">
                        </div>
                    </div>
...
?>
            ...
            <script src="../../n-libraries/js/checkoutv3.js?t=5"></script>
    </body>
</html>