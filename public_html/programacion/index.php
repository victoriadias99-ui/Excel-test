        ...
        <section>
            <div class="row">
                <div class="col-md-7 px-5 ">
                    <img class="d-block d-md-none img-fluid mb-4" style="border-radius: 10px;" src="assets/img/c.jpg" width="auto">
                    ...
                    <div class="d-block d-md-none mt-3">
                        ...
                        <div class="d-xl-flex align-items-xl-start p-3" style="border-radius: 10px;background: #ffffff;">
                    ...
                    <img class="d-none d-md-block img-fluid" src="assets/img/banner-aprende.png" width="100%">
                    <p></p>
                    <img class="d-none d-md-block img-fluid" src="assets/img/visual.png" width="100%">
            ...
            <div class="stop-card-madre row mt-5 mt-3 p-5 px-md-5" style="background: url(&quot;assets/img/banner2prueba.png&quot;);background-size: cover;">
            ...
            <div class="row px-3 px-md-5" style="background-image: url(assets/img/bannerfooter.png);
                ...
                <div class="col d-xl-flex justify-content-xl-center align-items-xl-center p-5">
                    <img class="img-fluid" src="assets/img/Programacion C.png">
                </div>
                <div class="d-xl-flex align-items-xl-center col-md-6 p-5">
                    <div>
                        ...
                        <a href="<?= $urlCheckout ?>" class="btn btn-primary px-5 ml-0" style="background: #fe9900;color: #Ffff;font-family: 'Raleway Bold';">Lo quiero</a>
                    </div>
                </div>
            </div>
        </section>
