...
<html>
    ...
    <body style="font-family: 'Raleway Regular';">
        <?php
        $headerImagen = "assets/img/banner-cvii.png";
            ...
            <div class="container">
                <div class="row p-4 p-md-0">
                    <div class="col-md-7 flex-column">
                        <div class="row">
                            <div class="col-md-5">
                                <img class="img-fluid rounded" src="../programacion/assets/img/c.jpg">
                            </div>
                            <div class="col-md-7 mt-4 mt-md-0">
                                <h5><b>Estás a unos clics de tener tu curso...</b></h5>
                                <h3><b>Domina Programación C#</b></h3>
                                <p class="mb-3">Aprendé a programar C#</p>
                            </div>
                        </div>
