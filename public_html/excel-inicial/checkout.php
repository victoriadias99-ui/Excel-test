            ...
            <div class="container">
                <div class="row p-4 p-md-0">
                    <div class="col-md-7 flex-column">
                        <div class="row">
                            <div class="col-md-5">
                                <img class="img-fluid rounded" src="../n-assets/img/imagen-header-excel-computadora-2.jpg">
                            </div>
                            <div class="col-md-7 mt-4 mt-md-0">
                                <h5><b>Estás a unos clics de tener tu curso...</b></h5>
                                <h3><b>Excel Inicial</b></h3>
                                <p class="mb-3">Aprende Excel en solo 3 horas con ejemplos reales y soporte siempre que lo necesites</p>
                            </div>
                        </div>
                            ...
                            <div class="col-12">
                                <div class="feature-list">
                                    <ul class="pl-0 px-md-3  px-0" style="list-style: none">
                                        ...
                                        <li class="text-dark"> <i class="fas fa-check-circle" ></i>Acceso para siempre a los cursos</li>
                                        <li class="text-dark"> <i class="fas fa-check-circle" ></i> Ayuda de los profesores</li>
                                        <li class="text-dark"> <i class="fas fa-check-circle" ></i>Videos muy bien explicados</li>
                                        <li class="text-dark"> <i class="fas fa-check-circle" ></i>+ 15.500 alumnos</li>
                                        <li class="text-dark"> <i class="fas fa-check-circle" ></i>+ 100 Ejercios Prácticos</li>
                                    </ul>
                                </div>
                            </div>-->
...
?>
        ...
        <script src="../n-libraries/js/checkoutv4.js?t=3"></script>
    </body>
</html>