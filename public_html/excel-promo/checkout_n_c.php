...
<html>
    ...
    <body style="font-family: 'Raleway Regular';">
        ...
        <div class="section ">
                ...
                <div class="row p-3">
                    <div class="col-md-6 order-md-2 px-0 px-md-4" style="padding: 80px 20px 20px;">
                        ...
                        <div class=" col-md-12 mt-5" style="">
                            <div class=" mb-0">
                                <p style="font-size:15px;">"Muy satisfecha. Todos los puntos explicados en detalle. Entendi muy bien cada uno de los temas, animo a la gente a que realice este curso"</p>
                                <div class="rating-user d-inline" style="color:#ffc107">
                                ...
                                <div class="blockquote-footer">
                                    <b style="font-size:15px;">Laura Miller</b>, Junín, Buenos Aires</div>
                            </div>
                        </div>
                    ...
                    <div class="order-md-2 border rounded bg-light my-5 py-5 px-md-4 col-md-5" style="">
                        ...
                        <ul class="list-group">
                            <li class="list-group-item d-flex justify-content-between">
                                <div>
                                    <h6 class="my-0"><b>Pack Excel Inicial, Intermedio, Avanzado y Certificación Internacional</b></h6> <small class="text-muted" style="font-size:13px;">Acceso de por vida</small>
                        ...
                        <hr>
                        <p class="text-left mt-2" style="font-size:15px;"><i class="fas fa-lock" style="color:green;"></i> Garantía de Satisfacción: Estamos tan seguros de que los cursos te van a encantar que si en los primeros 7 dias no estás conforme, te devolvemos el dinero 😊. Probalos, y si no estas satisfecho/a, te vamos a devolver el 100% de tu compra sin hacer preguntas. Tenés todas las de ganar adquiriendo este combo hoy!<p>
                        <div class="text-dark pt-5 " style="font-size:15px;" id="ch">
                            <h4 class="mt-3 pb-2"><b> ¿Por qué la gente nos elige? </b></h4>
                            <ul class="lead">
                                <li style="font-size:15px;"> <i class="fas fa-check-square " style="color:#009045;"></i>Acceso para siempre a los cursos</li>
                                <li style="font-size:15px;"><i class="fas fa-check-square " style="color:#009045;"></i>Ayuda de los profesores</li>
                                <li style="font-size:15px;"><i class="fas fa-check-square " style="color:#009045;"></i>Videos muy bien explicados</li>
                                <li style="font-size:15px;"><i class="fas fa-check-square " style="color:#009045;"></i>+15.500 alumnos</li>
                                <li style="font-size:15px;"><i class="fas fa-check-square " style="color:#009045;"></i>+100 Ejercios Prácticos</li>
                                ...
                                <div class="mx-auto col-10 m-form">
                                    <div class="row mb-3">
                                        <div class="row mb-3 mx-auto">
                                            <div class="mx-auto"> <img width="100%" alt="Mercado Pago - Medios de pago" title="Mercado Pago - Medios de pago" src="https://imgmp.mlstatic.com/org-img/banners/ar/medios/online/468X60.jpg"></div>
            ...
            <div class="container row   mx-auto text-dark">
