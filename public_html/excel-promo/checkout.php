                    ...
                    <div class="col-md-7 flex-column">
                        <div class="row">
                            ...
                            <div class="col-md-7 mt-4 mt-md-0">
                                ...
                                <h3><b>Pack experto en Excel</b></h3>
                                <p class="mb-3">Dominá la herramienta más solicitada por las empresas de todo el mundo. </p>
                            </div>
                        </div>
                            ...
                            <div class="col-12">
                                <div class="feature-list">
                                    <ul class="pl-0 px-md-3  px-0" style="list-style: none">
                                        ...
                                        <li class="text-dark"> <i class="fas fa-check-circle" ></i>+ 25.000 alumnos</li>
