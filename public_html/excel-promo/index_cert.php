    ...
    <body style="font-family: 'Raleway Regular';">
        ...
        <section>
            <div class="row">
                <div class="col-md-7 px-5 ">
                    ...
                    <h1 style="font-family: 'Raleway Black'; color:#00173B;">Certificate Internacionalmente como Experto en Excel</h1>
                    ...
                    <div class="d-block d-md-none mt-3">
                        ...
                        <ul class="lista-header pl-3" style="list-style-type: none;">
                                ...
                                <li style="font-size:14px;"><i class="fa fa-check" style="color: #008B69;"></i>&nbsp;75 videos pre-grabados (12hs) paso a paso<br></li>
                                ...
                                <li style="font-size:14px;"><i class="fa fa-check" style="color: #008B69;"></i>&nbsp;Incluye curso Nivel Inicial, Nivel Intermedio&nbsp;y Nivel Avanzado<br></li>
        ...
        <div class="card">
          ...
          <div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#accordionExample" style="">
            <div class="card-body" style="font-size:14px;"> ¡De por vida! Una vez que abones esta promo vas a tener acceso para siempre a ambos cursos. Los vas a poder descargar en tu PC, notebook, tablet o celular.</div>
          </div>
        </div>
        <div class="card">
          ...
          <div id="collapseTwo" class="collapse" aria-labelledby="headingThree" data-parent="#accordionExample" style="">
            <div class="card-body" style="font-size:14px;">12 hs de videos es la duración total de ambos cursos.</div>
          </div>
        </div>
        <div class="card">
        ...
        <div class="card">
          ...
          <div id="collapseFour" class="collapse" aria-labelledby="headingFour" data-parent="#accordionExample" style="">
            <div class="card-body" style="font-size:14px;">Una vez termines el curso podés solicitarnos gatis la Certificación Profesional emitida por <b>Educar</b>, con cooperación académica de <b>UTN, UBA y UNLP</b> mediante un convenio con la fundación Promover. Validez internacional en Latinoamérica y España.</div>
          </div>
        </div>
        <div class="card">
          ...
          <div id="collapseFive" class="collapse" aria-labelledby="headingFive" data-parent="#accordionExample" style="">
            <div class="card-body" style="font-size:14px;">No requiere conocimientos previos. Sólo necesitás una PC con el Excel instalado. Si no tenés Excel, dentro del curso te enseñamos cómo descargarlo gratis :)</div>
          </div>
        </div>
          <div class="card">
          ...
          <div id="collapseSix" class="collapse" aria-labelledby="headingSix" data-parent="#accordionExample" style="">
            <div class="card-body">
             ...
             <ul>
             <p class="  font-weight-bold" style="font-size:14px;"> CURSO NIVEL INICIAL</p>
                  <li style="font-size:14px;">Clase 1: Estructuras básicas de Excel</li>
                    <li style="font-size:14px;">Clase 2: Hacer una factura</li>
                    <li style="font-size:14px;">Clase 3: Hojas, libros</li>
                    <li style="font-size:14px;">Clase 4: Vista Backstage: libro, hojas, en la vista vemos botones inicio, nuevo y abrir</li>
                    <li style="font-size:14px;">Clase 5: Insertar Celdas Filas y Columnas</li>
                    <li style="font-size:14px;">Clase 6: Eliminar Celdas Filas y Columnas</li>
                    <li style="font-size:14px;">Clase 7: Ocultar y visualizar de nuevo filas y columnas sin eliminarlas</li>
                    <li style="font-size:14px;">Clase 8: Copiar, cortar y pegar celdas</li>
                    <li style="font-size:14px;">Clase 9: Formato a la tabla de datos Ajustar texto Alinear texto</li>
                    <li style="font-size:14px;">Clase 10: Formato simple monedas</li>
                    <li style="font-size:14px;">Clase 11: Creación de lista desplegable</li>
                    <li style="font-size:14px;">Clase 12: Ordenar la base de datos orden de A Z de Z A y personalizado</li>
                    <li style="font-size:14px;">Clase 13: Buscar y reemplazar</li>
                    <li style="font-size:14px;">Clase 14: Alternativas para copiar una hoja.</li>
                    <li style="font-size:14px;">Clase 15: Operaciones aritméticas (Sumar, Restar, Multiplicar, Dividir)</li>
                    <li style="font-size:14px;">Clase 16: Sumar por celda, sumar con formula y la funcion autosuma</li>
                    <li style="font-size:14px;">Clase 17: Multiplicación con selección de celdas y fórmula de PRODUCTO</li>
                    <li style="font-size:14px;">Clase 18: División por celdas y formula COCIENTE</li>
                    <li style="font-size:14px;">Clase 19: Calcular promedio de forma manual y fórmula PROMEDIO</li>
                    <li style="font-size:14px;">Clase 20: Validación de datos VERDADERO/FALSO</li>
                    <li style="font-size:14px;">Clase 21: Fórmula Condicional SI</li>
                    <li style="font-size:14px;">Clase 22: Fórmula Sumar.SI (Suma Condicional)</li>
                    <li style="font-size:14px;">Clase 23: Anclaje de celdas</li>
                    <li style="font-size:14px;">Clase 24: Formato de tablas, asignación de nombres a tablas</li>
                    <li style="font-size:14px;">Clase 25: Fórmula BUSCARV</li>
                    <li style="font-size:14px;">Clase 26: Formato Condicional</li>
                    <li style="font-size:14px;">Clase 27: Cifrar archivo, proteger y desproteger hoja y libro</li>
                    <li style="font-size:14px;">Clase 28: Gráfica en barra con una variable y formato de gráfica</li>
                    <li style="font-size:14px;">Clase 29: Gráfica de pastel o circular</li>
                    <li style="font-size:14px;">Clase 30: Gráfico de tiempo con varias variables</li>
                    <li style="font-size:14px;">Clase 31: Cómo imprimir en Excel</li>

              
              </ul>
              
              <ul>
                        <p class="  font-weight-bold mt-5" style="font-size:14px;"> CURSO NIVEL INTERMEDIO</p>
                        <li style="font-size:14px;">Clase 1: Estructuras básicas de excel</li>
                        <li style="font-size:14px;">Clase 1	    Tablas Dinámicas</li>
                        <li style="font-size:14px;">Clase 2	    Funciones Lógicas - Función SI &amp; SI ANIDADA</li>
                        <li style="font-size:14px;">Clase 3	    Funciones Lógicas - Función SI.ERROR</li>
                        <li style="font-size:14px;">Clase 4	    Funciones Lógicas -  Función (O) &amp; Y</li>
                        <li style="font-size:14px;">Clase 5	    Función CONCATENAR</li>
                        <li style="font-size:14px;">Clase 6	    Función INDIRECTO</li>
                        <li style="font-size:14px;">Clase 7	    Funciones de Texto</li>
                        <li style="font-size:14px;">Clase 8	    Función INDICE y COINCIDIR</li>
                        <li style="font-size:14px;">Clase 9	    Remover datos duplicados</li>
                        <li style="font-size:14px;">Clase 10	Función SUBTOTALES</li>
                        <li style="font-size:14px;">Clase 11	Funcion Pronostico</li>
                        <li style="font-size:14px;">Clase 12	Listas Desplegables Dependientes</li>
                        <li style="font-size:14px;">Clase 13	Listas Desplegables Dinámicas</li>
                        <li style="font-size:14px;">Clase 14	Creación y Grabación de Macros</li>
                        <li style="font-size:14px;">Clase 15	Ejecución y Automatización con Macros</li>
                        <li style="font-size:14px;">Clase 16	Crear plantilla para Gráficos</li>
                        <li style="font-size:14px;">Clase 17	Filtros Avanzados para Excel</li>
                        <li style="font-size:14px;">Clase 18	Análisis de Hipótesis</li>
                        <li style="font-size:14px;">Clase 19	Graficos Dinámicos</li>
                        <li style="font-size:14px;">Clase 20	Clase 20: Parte 1 - Modelo de datos para creacion de dashboard</li>
                        <li style="font-size:14px;">Clase 20	Clase 20: Parte 2 - Utilizacion de modelo de datos y creacion de dashboard</li>
                        <li style="font-size:14px;">Clase 21	Casos Practicos para los usuarios</li>
						
						<p class="  font-weight-bold mt-5" style="font-size:14px;"> CURSO NIVEL AVANZADO</p>
<li style="font-size:14px;">Clase 1 - Construcción Bases de datos</li>
<li style="font-size:14px;">Clase 2 - Filtros y limpieza de datos</li>
<li style="font-size:14px;">Clase 3 - Columnas primarias y formuladas</li>
<li style="font-size:14px;">Clase 4 - Principales fórmulas utilizadas en las Bases de Datos</li>
<li style="font-size:14px;">Clase 5 - Buscarv</li>
<li style="font-size:14px;">Clase 6 - Buscarh</li>
<li style="font-size:14px;">Clase 7 - Coindicir</li>
<li style="font-size:14px;">Clase 8 - KPI´s</li>
<li style="font-size:14px;">Clase 9 -  Estadística Descriptiva</li>
<li style="font-size:14px;">Clase 10 - Media Móvil</li>
<li style="font-size:14px;">Clase 11 - Regresión lineas</li>
<li style="font-size:14px;">Clase 12 – Diseños</li>
<li style="font-size:14px;">Clase 12 - Minigráficos</li>
<li style="font-size:14px;">Clase 13 - Líneas de tendencia</li>
<li style="font-size:14px;">Clase 14 - Histogramas</li>
<li style="font-size:14px;">Clase 15 - Instalación</li>
<li style="font-size:14px;">Clase 16 - Conexión de Bases de datos</li>
<li style="font-size:14px;">Clase 17 - Columnas formuladas</li>
<li style="font-size:14px;">Clase 18 - Creación de modelos y conexión entre tablas</li>  
<li style="font-size:14px;">Clase 19 - Análisis de datos y construcción de gráficos</li>  
<li style="font-size:14px;">Clase 20 - Formularios - Definición de objeto</li>  
<li style="font-size:14px;">Clase 21 - Uso de controles - Detallar controles y características</li>  
<li style="font-size:14px;">Clase 22 - Diseño de formularios - Pasos para un buen diseño</li>
<li style="font-size:14px;">Clase 23 - Automatización - Formularios y macros</li>   
<li style="font-size:14px;">Clase 24 - Introducción VBA - Programación VBA</li>  
                ...
                <div class="col-md-2 offset-md-1 mb-2 mb-md-0">
                    <div class="px-2 py-4" style="border-radius: 10px;box-shadow: 10px 10px 20px 3px rgb(205,205,205);background: #ffffff;">
                        <div class="col" style="text-align: center;"><img class="img-fluid card-imagen-section-2" src="assets/img/icon-5-1.png">
                            <h5 class="mt-3" style="font-family: 'Raleway Bold';color: #00173B;">12hs de contenido</h5>
                        </div>
                    </div>
                </div>
            ...
            <div class="row px-3 px-md-5" style="background: linear-gradient(90deg, #007a6a, #008c69 71%, #5e892b 100%);">
                <div class="d-xl-flex align-items-xl-center col-md-6 p-5">
                    <div>
                        ...
                        <p class="mt-5" style="color: rgb(255,255,255);">Accedé hoy y obtén los 3 cursos de por vida. Pago por única vez (sin suscripciones ni pagos mensuales).<br></p>
