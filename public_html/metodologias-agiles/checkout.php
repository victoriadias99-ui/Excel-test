...
<html>
    ...
    <body style="font-family: montserrat_regular;">
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-md-2 col-sm-6 col-6 logo">
                        <a href="../" target="_blank"> <img src="img/LogoAE.png" alt="logo" class="img-fluid" width=""> </a>
                    </div>
                </div>
            </div>
        </header>
        ...
        <div class="pt-5" style="background-color:#00a8f3">
            <div class="container">
                <div class="row">
                    <div class="col-md-4  mr-auto order-2 order-md-1"> <img class="img-fluid d-block" src="img/ma2.jpg"> </div>
            ...
            <div class="container bg-light rounded ">
                <div class="row ">
                    <div class="col-md-5 mx-auto  my-auto" style="padding: 80px 20px;">
                        ...
                        ?>
                        <ul class="list-group mt-4 text-dark">
                            <li class="list-group-item d-flex justify-content-between">
                                <div>
                                    <h6 class="my-0"><b>Curso de Metodologías Ágiles</b></h6> <small class="text-muted">Acceso de por vida</small>
                        ...
                        <div class="row mx-2 ">
                            <div class="col-md-12 text-dark">
                                ...
                                <ul>
                                    <li> <i class="fas fa-check-square " style="color:#00a8f3;"></i> +29 clases</li>
                            ...
                            <div class=" col-md-12" style="">
                                <div class=" mb-0 text-dark">
                                    <p>"Excelente! Muy completo el curso, ideal para adentrarse al mundo agile"</p>
                                ...
                                <hr>
                                <div class=" mb-0 text-dark">
                                    <p>"El profesor explica paso a paso, muy entendible.&nbsp; Me gusto"</p>
                                    <div class="rating-user d-inline">
                                        <i class="fa fa-star"></i>
                                        <i class="fa fa-star"></i>
                                        <i class="fa fa-star"></i>
            ...
            <div class="py-5 text-center">
                <div class="container">
                    ...
                    <div class="row text-center">
                        ...
                        <div class="col-md-4 text-center">
                            <a class="" target="_blank" href="https://api.whatsapp.com/send?phone=5491168787291&amp;text=Hola!%20Te%20escribo%20por%20el%20Curso%20de%20Metodologías Ágiles"> <img class="img-fluid d-block mx-auto mx-md-1" src="img/whatsapp.jpg"></a>
                        </div>
                        <div class="col-md-4 text-center">
                        </div>
                    </div>
