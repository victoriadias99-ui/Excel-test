            ...
            <div class="container">
                <div class="row p-4 p-md-0">
                    <div class="col-md-7 flex-column">
                        <div class="row">
                            <div class="col-md-5">
                                <img class="img-fluid rounded" src="../microsoft-sql-server/assets/img/imagen-header.png">
                            </div>
                            <div class="col-md-7 mt-4 mt-md-0">
                                <h5><b>Estás a unos clics de tener tu curso...</b></h5>
                                <h3><b>Domina SQL Server</b></h3>
                                <p class="mb-3">Aprendé y dominá SQL Server en pocas horas</p>
                            </div>
                        </div>
