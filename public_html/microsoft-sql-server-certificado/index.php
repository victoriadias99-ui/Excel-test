...
// SEO
$seo_title = 'Curso de SQL Server con Certificación Oficial Online | Base de Datos Profesional';
$seo_description = 'Curso de Microsoft SQL Server con certificación oficial online. Domina bases de datos, consultas SQL avanzadas y administración. Líderes en capacitaciones laborales.';
$seo_keywords = 'curso sql server certificado, certificación sql server, bases de datos profesional, sql avanzado, administración sql, capacitaciones laborales, analista de datos';
$seo_slug = 'microsoft-sql-server-certificado';
$seo_og_title = 'Curso de SQL Server Certificado Online | Aprende Excel';
$seo_image = 'https://aprende-excel.com/n-img/sqlserver4.jpeg';
$seo_structured_data = json_encode([
    "@context" => "https://schema.org",
    "@type" => "Course",
    "name" => "Microsoft SQL Server con Certificación",
    "description" => "SQL Server con certificación oficial. Bases de datos y administración profesional.",
    "provider" => ["@type" => "Organization", "name" => "Aprende Excel", "url" => "https://aprende-excel.com"],
    "url" => "https://aprende-excel.com/microsoft-sql-server-certificado/",
        ...
        <section>
            <div class="row">
                <div class="col-md-7 px-5 ">
                    ...
                    <h1 style="font-family: 'Raleway Black'; color:#00173B;">Dominá SQL Server y certificate</h1>
                    ...
                    <p class="mt-4 mb-5" style="color: rgb(85,85,85);font-family: 'Raleway Regular';">Nuestro curso de SQL Server garantiza total satisfacción y aprendizaje.</p>
                    ...
                    <ul class="lista-header pl-3 mt-2" style="list-style-type: none;">
                        ...
                        <li><i class="fa fa-check" style="color: #333333;"></i>&nbsp;Claúsulas de SQL y aprenderás a ordenar los datos de muchas maneras
                            <br></li>
                        <li>Requsitos:<br>
                            Necesitás una PC o Notebook con MySQL Server instalado.</li>
                    </ul>
                    <div class="p-4 mt-5" style="background: url(&quot;assets/img/banner2.png&quot;) no-repeat;background-size: cover;font-size: 0.8em;border-radius: 10px;">
                        ...
                        <p style="color: rgb(255,255,255);">Abre tus puertas a nuevas oportunidades. Dominá SQL Server por completo en solo 12 horas y con soporte 24/7&nbsp;</p>
                    ...
                    <h5 class="mt-4" style="font-family: 'Raleway Bold';color: #00173B;">Aprender SQL Server desde casa nunca ha sido tan simple</h5>
                    <div class="row mt-3">
                        ...
                        <div class="col text-center text-md-left">
                            ...
                            <div class="d-xl-flex text-center text-md-left justify-content-xl-start align-items-xl-start position-relative p-3 mb-2" style="border-radius: 10px; background-image: url(assets/img/banner-bonus-2.png); background-repeat: no-repeat; background-size: cover;background-position: center;"><img class="img-fluid" src="assets/img/ico-bonus-2.png" style="width: 50px;">
                                <div class="ml-md-4">
                                    ...
                                    <h5 style="font-family: 'Raleway Bold';color: #00173B;">Ejercicios Practicos - Similares al trabajo real</h5>
                                    <p class="texto-aun-mas" style="font-size: 0.7em;">Aprenderás cómo crear y mantener una base de datos con los comandos aprendidos</p>
                                </div>
                            </div>
            ...
            <div class="stop-card-madre row mt-5 mt-3 p-5 px-md-5" style="background: url(&quot;assets/img/background-rojo.png&quot;);background-size: cover;">
                    ...
                    <div class="accordion mt-4" id="accordionExample">
                        ...
                        <div class="card">
                            ...
                            <div id="collapseFive" class="collapse" aria-labelledby="headingFive" data-parent="#accordionExample" style="">
                                <div class="card-body">No requiere conocimientos previos. Sólo necesitás una PC o Notebook con el SQL SERVER instalado. Si no lo tenés, dentro del curso te enseñamos cómo descargarlo</div>
                            </div>
                        </div>
