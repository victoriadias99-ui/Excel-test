            ...
            <div class="container">
                <div class="row p-4 p-md-0">
                    <div class="col-md-7 flex-column">
                        <div class="row">
                            <div class="col-md-5">
                                <img class="img-fluid rounded" src="../../plantillas/finanzas/assets/img/finanzas.png">
                            </div>
                            <div class="col-md-7 mt-4 mt-md-0">
                                <h5><b>Estás a unos clics de tener tu curso...</b></h5>
                                <h3><b>Plantillas de Finanzas</b></h3>
                                <p class="mb-3">Dominá a fondo esta herramienta y adquirí un conocimiento imprescindible en la actualidad 🏆</p>
                            </div>
                        </div>
                            ...
                            <div class="col-12">
                                <div class="feature-list">
                                    <ul class="pl-0 px-md-3  px-0" style="list-style: none">
                                        ...
                                        <li class="text-dark"> <i class="fas fa-check-circle" ></i>Califiacion 4.9/5</li>
                                        <li class="text-dark"> <i class="fas fa-check-circle" ></i>Soporte 24/7</li>
                                    </ul>
                                </div>
                            </div>
