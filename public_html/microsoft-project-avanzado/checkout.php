...
<body style="font-family:montserrat_regular">
  ...
  <div class="pt-5">
    <div class="container">
      <div class="row">
        <div class="col-md-4  mr-auto order-2 order-md-1"> <img class="img-fluid d-block" src="img/5.jpg"> </div>
        <div class="px-md-5 p-3 d-flex flex-column align-items-start justify-content-center col-md-7 order-1 order-md-2" style="">
           <h3 class="mb-3" style="font-family: montserrat_bold">Dominá a fondo esta herramienta y convertite en un experto de la planificación de proyectos.
		   <b><p><b>
		   <p>Este curso es<span class="bg-success text-white px-2">imprescindible</span> en la actualidad</h3>
      ...
      <div class="row">
        <div class="col-md-6 order-md-2 px-0 px-md-4" style="padding: 80px 20px 20px;">
          ...
          <div class=" col-md-12 mt-5" style="">
            <div class=" mb-0">
              <p>"es sencillo, práctico..fácil de entender...podes volver a verlo cuando quieras..me sirvió para el trabajo"</p>
              ...
              <div class="blockquote-footer">
                <b>Sofia Bermudez</b>, CABA</div>
            </div>
          </div>
          <div class=" col-md-12 mt-5" style="">
            <div class=" mb-0">
              <p>"Muchas gracias. Quiero felicitarlos por los cursos, son muy entendibles y tienen una buena estructura para el avance en el aprendizaje."</p>
              <div class="rating-user d-inline">
                <i class="fa fa-star"></i>
                <i class="fa fa-star"></i>
                <i class="fa fa-star"></i>
              ...
              <div class="blockquote-footer">
                <b>Matias Leonel</b>, Santa Fe</div>
            </div>
          </div>
    ...
    <?php
          ...
          <ul class="list-group mt-4">
            <li class="list-group-item d-flex justify-content-between">
              <div>
                <h6 class="my-0"><b>Project nivel Avanzado</b></h6> <small class="text-muted">Acceso de por vida</small>
             ...
             <?php
                            foreach ($data['pack'] as $c => $item) {
                                ...
                                <?php
                                    ...
                                    ?>
                                <input type="number" id="<?= $item['ID_ABRE_PACK'] ?>_code" value="<?= $item['ID_UPSELL'] ?>" hidden>
                                        <?php
                                }
                            }
                            ?>
              ...
              <div class="mx-auto col-10 m-form">
                <div class="row mb-3">
                  <div class="row mb-3 mx-auto">
                    <div class="mx-auto"> <img class="img-fluid d-block mx-auto pt-2" src="../a-img/security.png"></div>
  ...
  <div class="py-5 text-center">
    <div class="container">
      ...
      <div class="row text-center">
        ...
        <div class="col-md-4 text-center">
          <a class="" href="https://api.whatsapp.com/send?phone=5491168787291&amp;text=Hola!%20Te%20escribo%20por%20el%20curso%20de%20Project%20Avanzado"> <img class="img-fluid d-block  mx-auto" src="img/whatsapp.jpg"> </a>
        </div>
        <div class="col-md-4 text-center">
        </div>
      </div>
