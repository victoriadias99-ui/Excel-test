<?php
$dirpage = '../';
$titulo = 'Aprende Power BI + Certificación Internacional';

$idcurso = 'combopowbicert';
...
$precioCurso = '$' . $value;
$urlCheckout = './checkout_powerbicombo_cert.php';
/*
$value = 'ddd';
$porcentaje = 'ddd';
        ...
        <section>
            <div class="row">
                <div class="col-md-7 px-5 ">
                    ...
                    <h1 style="font-family: 'Raleway Black'; color:#00173B;">Certificate Internacionalmente como <span style="color: #ffc902;">Experto  Power BI</span></h1>
                    ...
                    <div class="d-block d-md-none mt-3">
                        ...
                        <p class="mb-4" style="color: #555555;font-family: 'Raleway Regular';">A través de este curso con Certificado Internacional, vas a aprender a conocer todas las funciones de Power BI, realizar tableros, análisis de datos y mucho más. Explicado paso a paso en 7:30 horas de videos por un profesor certificado de la Universidad Tecnológica Nacional (UTN)</p>
                        <p class="mb-4" style="color: #555555;font-family: 'Raleway Regular';"><b>Requsitos:</b> Una PC con Power BI instalado. Si no tenes instalado <b>Power bi</b> a traves de <a href="https://www.microsoft.com/en-us/download/details.aspx?id=58494">este enlace</a> podras descargarlo.</p>
                    
                        <ul class="lista-header pl-3" style="list-style-type: none;">
                                <li><i class="fa fa-check" style="color: #333333;"></i>&nbsp;7.30hs de video paso a paso<br></li>
                                ...
                                <li><i class="fa fa-check" style="color: #333333;"></i>&nbsp;Otorgamos Certificado Internacional<br></li>
                            </ul>
                    ...
                    <p class="item-sec2"><img src="assets/img/icono-s2-1.png">&nbsp; +7:30 horas de contenido para verlos donde y cuando quieras.</p>
                    ...
                    <div class="p-4 mt-5" style="background: url(&quot;assets/img/banner2.png&quot;) no-repeat;background-size: cover;font-size: 0.8em;border-radius: 10px;">
                        ...
                        <p style="color: rgb(255,255,255);">Abre tus puertas a nuevas oportunidades. Domina Power BI por completo en poco tiempo y con soporte 24/7&nbsp;</p>
                    ...
                    <h5 class="mt-4" style="font-family: 'Raleway Bold';color: #00173B;">Aprender Power Bi desde casa nunca ha sido tan simple</h5>
                    <div class="row mt-3">
                    ...
                    <div class="card-madre px-3 py-4 mr-5" style="position: fixed; border-radius: 10px;box-shadow: 10px 10px 20px 14px rgb(205,205,205);background: #ffffff;">
                        <div class="col">
                            ...
                            <ul class="lista-header pl-3" style="list-style-type: none;">
                                ...
                                <li><i class="fa fa-check" style="color: #333333;"></i>&nbsp;Videos pre-grabados (7.30hs) paso a paso<br></li>
                                <li><i class="fa fa-check" style="color: #333333;"></i>&nbsp; 20 Ejercicios Prácticos<br></li>
                                <li><i class="fa fa-check" style="color: #333333;"></i>&nbsp;Incluye curso power bi inicial&nbsp;y Nivel Avanzado<br></li>
                ...
                <div class="col-md-6">
                    ...
                    <div class="card">
                        ...
                        <div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#accordionExample" style="">
                            <div class="card-body"> ¡De por vida! Una vez que abones vas a tener acceso para siempre. Lo vas a poder descargar en tu PC o celular.</div>
                        </div>
                    </div>
                    <div class="card">
                        ...
                        <div id="collapseTwo" class="collapse" aria-labelledby="headingThree" data-parent="#accordionExample" style="">
                            <div class="card-body">7.30hs de videos es la duración total del curso.</div>
                        </div>
                    </div>
                    <div class="card">
            ...
            <div class="card-body" style="font-size:14px;">Una vez termines el curso podés solicitarnos gratis la Certificación Profesional emitida por <b>Educar</b>, con cooperación académica de <b>UTN, UBA y UNLP</b> mediante un convenio con la fundación Promover. Validez internacional en Latinoamérica y España.</div>
                        </div>
                    </div>
                    <div class="card">
                ...
                <div class="col-md-2 offset-md-1 mb-2 mb-md-0">
                    <div class="px-2 py-4" style="border-radius: 10px;box-shadow: 10px 10px 20px 3px rgb(205,205,205);background: #ffffff;">
                        ...
                        <img class="img-fluid card-imagen-section-2" src="assets/img/icon-5-1.png">
                            <h5 class="mt-3" style="font-family: 'Raleway Bold';color: #00173B;">7:30hs de contenido</h5>
                        </div>
                    </div>
                </div>
