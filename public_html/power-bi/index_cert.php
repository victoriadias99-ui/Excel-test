        ...
        <section>
            <div class="row">
                <div class="col-md-7 px-5 ">
                    ...
                    <h1 style="font-family: 'Raleway Black'; color:#00173B;">Certificate Internacionalmente en<span style="color: #ffc902;">Power BI</span></h1>
                    ...
                    <div class="d-block d-md-none mt-3">
                        ...
                        <p class="d-none d-md-block mb-4" style="color: #555555;font-family: 'Raleway Regular';"><b>Requsitos:</b> Una PC con Power BI instalado. En caso de que no lo tengas a traves de <a href="https://www.microsoft.com/en-us/download/details.aspx?id=58494">este enlace</a> podras descargarlo siguiendo los pasos.</p>
                        ...
                        <ul class="lista-header pl-3" style="list-style-type: none;">
                                ...
                                <li><i class="fa fa-check" style="color: #333333;"></i>&nbsp; 20 Ejercicios Teóricos<br></li>
                    ...
                    <div class="card-madre px-3 py-4 mr-5" style="position: fixed; border-radius: 10px;box-shadow: 10px 10px 20px 14px rgb(205,205,205);background: #ffffff;">
                        <div class="col">
                            ...
                            <ul class="lista-header pl-3" style="list-style-type: none;">
                                ...
                                <li><i class="fa fa-check" style="color: #333333;"></i>&nbsp;16 videos pre-grabados paso a paso<br></li>
