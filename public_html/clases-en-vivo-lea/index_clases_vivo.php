    ...
    <body style="font-family: 'Raleway Regular';">
        ...
        <section>
                ...
                <div class="col-md-12 px-5 ">
                    ...
                    <div class="d-block d-md-none mt-3">
                        ...
                        <ul class="lista-header pl-3" style="list-style-type: none;">
                                ...
                                <li style="font-size:14px;"><i class="fa fa-check" style="color: #008B69;"></i>&nbsp;Incluye curso Nivel Inicial Y Nivel Intermedio&nbsp;<br>.</li>
                        ...
                        <div class="d-xl-flex align-items-xl-start p-3" style="border-radius: 10px;background: #EDF3F4;">
                                ...
                                <p class="ml-2 mt-2" style="font-size: 0.7em;">No es un secreto. Lo sabés. El mercado laboral se encuentra saturado. Las empresas reciben cientos de currículums cada vez que se abre una nueva vacante. Necesitás destacar, hacerlo diferente y sumar nuevas habilidades y destrezas.</b>.</p>
                            </div>
                    </div>
                    ...
                    <p class="mt-4 mb-5" style="color: rgb(85,85,85);font-family: 'Raleway Regular';">Estas clases estan valoradas por <b><?=$precioCursoOficial?></b> pero puede acceder a esta oferta limitada por sólo:</p>
            ...
            <div class="section   py-5 col-md-12" style="background: rgb(33,163,99);background: linear-gradient(180deg, rgba(33,163,99,1) 31%, rgba(17,125,67,1) 67%);">
                <div class="container px-3 text-white">
                    ...
                    <div class="bg-white rounded   text-dark p-4">
                        ...
                        <li><span class="font-weight-bold">Mesas:</span> Diciembre y Enero a confirmar </li>

                        <li><span class="font-weight-bold">Precio:</span> Único pago de $4.999</li>
            ...
            <div class="row mt-0 mt-md-5 px-3">
                ...
                <a class="btn btn-block py-3 px-5 md-4 hearbeat col md-4 mx-auto text-center" style="font-size: 30px; background-color: #f2af6b; color: white; border-radius: 0;" href="#" role="button">Información</a>
            </div>
