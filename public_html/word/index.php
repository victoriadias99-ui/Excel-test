...
<body>
    ...
    <header style="background-color:#27569A;">
        <div class="container">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-5" style="">
                    <div class="">
                        <img src="img/word.jpg" class="img-fluid" alt="product">
                    </div>
                </div>
                <div class="col-md-1">&nbsp;</div>
                <div class="col-md-6">
                    <div class="section-heading">
                        <h3 style="color:black;">Dominá Word en profundidad</h3>
    ...
    <!-- Intro Section -->
    <div class="py-5 text-center mt-5 pt-5 bg-dark-blue" style="background-color:#27569A;">
        <div class="container">
            <div class="row">
                <div class="mx-auto col-md-12">
                    <h3 class="text-white display-4">Dominá Word en profundidad</h3>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-9 px-md-5 mx-auto" style="">
                    <p class="lead mb-4">A través de este curso vas a aprender a dominar Microsoft Word a un nivel completo, consiguiendo dominar la mayoría de sus funciones generales y avanzadas de esta herramienta. Explicado paso a paso en 3 horas de videos.<br></p>
                    <hr>
    ...
    <div class="py-5 bg-blue text-white" style="background-color:#27569A;">
        <div class="container ">
            <div class="row mx-auto">
                <div class="col-lg-5 col-md-6 p-md-4   mx-0 px-0 "> <img class="img-fluid d-block img-thumbnail rounded shadow  " src="img/word2.jpg" width="1500"> </div>
                <div class="col-md-6 offset-lg-1 d-flex flex-column justify-content-center py-4">
                    ...
                    <ul class="mx-auto mx-md-1">
                        <li><i class="fas fa-check text-success "></i> Crear documentos de manera profesional</li>
                        <li><i class="fas fa-check text-success "></i> Manejar Auto-corrección y Auto-texto</li>
                        <li><i class="fas fa-check text-success "></i> Usar Temas</li>
                        <li><i class="fas fa-check text-success "></i> Crear Indices y glosarios</li>
                        <li><i class="fas fa-check text-success "></i> Aplicar Formato de Letra y Párrafo</li>
                        <li><i class="fas fa-check text-success "></i> Crear tablas de contenido</li>
                        <li><i class="fas fa-check text-success "></i> Conocer de Estilos</li>
                        <li><i class="fas fa-check text-success "></i> Manejar apropiadamente los saltos de sección en Micosoft Word</li>
                        <li><i class="fas fa-check text-success "></i>Encabezados y pie de página</li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="container my-3">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 p-4 text-center">
                    ...
                    <p class="mb-3"><i>"</i>La verdad que es buenisimo el profesor como explica<i>"</i> </p>
                    <p class="mb-1"> <b>Julian Pineda</b></p>
                ...
                <div class="col-lg-4 col-md-6 p-4 text-center">
                    ...
                    <p class="mb-3">"Super sencilla las explicaciones</p>
                    <p class="mb-1"> <b>Marta Selvia</b></p>
                    <div class="rating-user d-inline">
                        <i class="fa fa-star"></i>
                        <i class="fa fa-star"></i>
                        <i class="fa fa-star"></i>
                ...
                <div class="col-lg-4 p-4 text-center">
                    ...
                    <p class="mb-1"> <b>Sofia Nuñez</b></p>
                    <div class="rating-user d-inline">
                        <i class="fa fa-star"></i>
                        <i class="fa fa-star"></i>
                        <i class="fa fa-star"></i>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-md-6 p-4 text-center">
                    ...
                    <p class="mb-3">"La información es clara y precisa, el profe es muy bueno para explicar cada uno de los temas."</p>
                    <p class="mb-1"> <b>Maximiliano Pintos</b></p>
                    <div class="rating-user d-inline">
                        <i class="fa fa-star"></i>
                        <i class="fa fa-star"></i>
                        <i class="fa fa-star"></i>
            ...
            <div class="accordion mt-4" id="accordionExample">
                ...
                <div class="card">
                    ...
                    <div id="collapseFive" class="collapse" aria-labelledby="headingFive" data-parent="#accordionExample" style="">
                        <div class="card-body">No necesitas ningun conocimiento, solamente tener instalado el programa Microsoft Word en el dispositivo que uses</div>
                    </div>
                </div>
                <div class="card">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6" style="">
                    <div class="section-heading">
                        ...
                        <h2 class="font-weight-bold text-left">Dominá Word en profundidad</h2>
                    </div>
                    <div class="feature-list mt-4">
