...
<html>
    ...
    <body>
        ...
        <div class="pt-5">
            <div class="container">
                <div class="row">
                    <div class="col-md-4  mr-auto order-2 order-md-1"> <img class="img-fluid d-block" src="img/word.jpg"> </div>
                    <div class="px-md-5 p-3 d-flex flex-column align-items-start justify-content-center col-md-7 order-1 order-md-2" style="">
                        <h1 class="font-weight-bold">Aprende Word - Curso a distancia</h1>
                        <p class="mb-3 lead">Lleva tu conocimientos de Word a un nivel completo 🏆</p>
                    ...
                    <div class="col-md-5 mx-auto  my-auto" style="padding: 80px 20px;">
                        ...
                        <ul class="list-group">
                            <li class="list-group-item d-flex justify-content-between">
                                <div>
                                    <h6 class="my-0 text-dark">Word </h6> <small class="text-muted">De por vida</small>
                        ...
                        <div class="row mx-2 ">
                            ...
                            <div class=" col-md-12" style="">
                                <div class=" mb-0 text-dark">
                                    <p>"Excelente!
                                        Muy clara la explicación y aprendí cosas que ni conocia"</p>
                                    ...
                                    <div class="blockquote-footer">
                                        <b>Sebastian Mendia</b>, Buenos Aires</div>
                                </div>
                            </div>
                        </div>  
                        <hr>
            ...
            <div class="py-5 text-center text-dark mt-5"><hr>
                ...
                <div class="container">
                    ...
                    <div class="row text-center">
                        ...
                        <div class="col-md-4 text-center">
                            <a class="" href="https://api.whatsapp.com/send?phone=5491168787291&amp;text=Hola!%20Te%20escribo%20por%20el%20curso%20de%20Word" target="_blank"> <img class="img-fluid d-block  mx-auto" src="img/whatsapp.jpg"> </a>
                        </div>
                        <div class="col-md-4 text-center">
                        </div>
                    </div>
