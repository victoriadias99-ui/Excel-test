...
<html>
    ...
    <body>
        ...
        <div class="pt-5">
            <div class="container">
                <div class="row">
                    <div class="col-md-4  mr-auto order-2 order-md-1"> <img class="img-fluid d-block" src="img/banner2_.jpg"> </div>
        ...
        <div class="text-white jp_banner_jobs_categories_wrapper bg-white float_left pt-5 pb-0 mx-auto mx-1">
            ...
            <div class="py-5 text-center text-dark mt-5">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <h3 class="mt-2 font-weight-bold" style="font-family: montserrat_bold;">¿Querés hablar con nosotros? ¡Escribinos!</h3>
                        </div>
                    </div>
                    <div class="row text-center">
                        ...
                        <div class="col-md-4 text-center">
                            <a class="" href="https://api.whatsapp.com/send?phone=5491168787291&amp;text=Hola!%20Te%20escribo%20por%20el%20curso%20Intermedio%20de%20Excel" target="_blank"> <img class="img-fluid d-block  mx-auto" src="img/whatsapp_.jpg"> </a>
                        </div>
                        <div class="col-md-4 text-center">
                        </div>
                    </div>
