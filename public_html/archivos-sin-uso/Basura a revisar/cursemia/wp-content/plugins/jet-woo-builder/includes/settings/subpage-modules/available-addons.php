...
class Available_Addons extends Page_Module_Base {
	...
	public function enqueue_module_assets() {
		...
		wp_enqueue_script(
			...
			jet_woo_builder()->plugin_url( 'assets/js/admin-vue-components.min.js' ),
			array( 'cx-vue-ui' ),
			jet_woo_builder()->get_version(),
			true
		);
	...
	public function page_templates( $templates = array(), $page = false, $subpage = false ) {
		...
		$templates['jet-woo-builder-available-addons'] = jet_woo_builder()->plugin_path( 'templates/admin-templates/available-addons-settings.php' );
