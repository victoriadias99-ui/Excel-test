...
// Enqueue integration stylesheets
...
/**
 * Enqueue JupiterX integration stylesheets
 *
 * @return void
 * @since  1.7.5
 * @access public
...
function jet_woo_jupiterx_enqueue_styles() {
	wp_enqueue_style(
		...
		jet_woo_builder()->plugin_url( 'includes/integrations/themes/jupiterx/assets/css/style.css' ),
		false,
