	...
	public function get_settings( $current_section = '' ) {
		...
		$settings = array(
			...
			array(
				...
				'desc'    => sprintf( __( 'Force use of AJAX Add to Cart instead of page reload on the product single page. Make sure you enable AJAX  <a href="%s">add to cart behaviour</a>.', 'jet-woo-builder' ), admin_url( 'admin.php?page=wc-settings&tab=products' ) ),
