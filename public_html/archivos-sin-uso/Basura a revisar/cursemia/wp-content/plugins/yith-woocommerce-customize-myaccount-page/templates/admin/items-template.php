	...
	<div class="item-content">
		...
		<div class="item-options">
			<table class="options-table form-table">
				<tbody>
				<?php foreach ( yith_wcmap_admin_get_fields( 'endpoint' ) as $field => $field_options ) :
...
<div class="item endpoint new-item-template">
	<div class="item-content">
		...
		<div class="item-options">
			<table class="options-table form-table">
				<tbody>
				<?php foreach ( yith_wcmap_admin_get_fields( 'link' ) as $field => $field_options ) :
					yith_wcmap_admin_print_single_field( $field_options, $field, 'yith_wcmap_endpoint_new', '' );
				endforeach; ?>
				</tbody>
			</table>
...
<div class="item endpoint new-item-template">
	<div class="item-content">
		...
		<div class="item-options">
			<table class="options-table form-table">
				<tbody>
				<?php foreach ( yith_wcmap_admin_get_fields( 'group' ) as $field => $field_options ) :
					yith_wcmap_admin_print_single_field( $field_options, $field, 'yith_wcmap_endpoint_new', '' );
				endforeach; ?>
				</tbody>
			</table>
