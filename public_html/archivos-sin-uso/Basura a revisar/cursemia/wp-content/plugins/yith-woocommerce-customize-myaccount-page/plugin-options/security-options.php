...
$security = array(
	...
	'security' => array(
		...
		array(
			...
			'desc'      => sprintf( __( 'Enable reCaptcha in registration form. %sRead more here >%s', 'yith-woocommerce-customize-myaccount-page' ), '<a href="https://www.google.com/recaptcha/about/" target="_blank">', '</a>' ),
			'type'      => 'yith-field',
			'yith-type' => 'onoff',
