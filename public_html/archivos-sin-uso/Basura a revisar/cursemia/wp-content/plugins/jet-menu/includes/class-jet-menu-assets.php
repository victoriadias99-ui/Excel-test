...
if ( ! class_exists( 'Jet_Menu_Assets' ) ) {
	...
	class Jet_Menu_Assets {
		...
		public function register_public_assets() {
			...
			$public_styles_depend = apply_filters( 'jet-menu/assets/public-styles-dependencies', array(
				'font-awesome-all',
				'font-awesome-v4-shims',
				)
			);
			...
			$public_script_depend = apply_filters( 'jet-menu/assets/public-script-dependencies',
				array(
					'jquery',
					'jet-vue',
				)
			...
			if (strpos($_SERVER['HTTP_USER_AGENT'], 'Trident/7.0; rv:11.0') !== false) {
				$public_script_depend[] = 'jet-menu-polyfills';
			}
