			...
			'controls' => [
              ...
              -webkit-animation-fill-mode: both;
				...
				'dce_smoothtransition_settings_note' => [
					'type' => Controls_Manager::RAW_HTML,
					'raw' => __( 'The selector wrapper is very important for the proper functioning of the transitions. It indicates the part of the page that needs to be transformed. <a href="https://help.dynamic.ooo/en/articles/4952536-html-structure-of-themes" target="_blank">This article can help you.</a>', 'dynamic-content-for-elementor' ),
					'content_classes' => '',
					'condition' => [
						'enable_smoothtransition' => 'yes',
					],
