(function ($) {
    var WidgetElements_FormHandler = function ($scope, $) {
        ...
        if (summary) {
            ...
            $scope.on('click', '.dce-form-step-summary-edit', function () {
                var step_id = jQuery(this).attr('data-target');
                var element_id = jQuery(this).attr('data-element');
                dce_show_step(step_id, element_id);
            });
