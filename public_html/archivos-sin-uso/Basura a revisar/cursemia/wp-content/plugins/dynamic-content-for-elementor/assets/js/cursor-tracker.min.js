...
cursorTarget.prependTo("body");var container=document.getElementsByTagName("body")[0];var cursors=cursorTarget[0];var cursorswrap=cursorTarget.find('.cursor-wrap');function positionCircle(elem){var relX=elem.clientX;var relY=elem.clientY;gsap.to(cursors,{duration:1,x:relX+"px",y:relY+"px"})}
container.addEventListener("mouseenter",function(n){gsap.to(cursors,{duration:0.5,scale:1})});container.addEventListener("mouseleave",function(n){gsap.to(cursors,{duration:0.5,scale:0})});container.addEventListener("mousemove",function(e){positionCircle(e)});var t=document.getElementById("cursor"),e=document.getElementById("cursor2"),i=document.getElementById("cursor3");function n(t){cursors.classList.add("hover")}
