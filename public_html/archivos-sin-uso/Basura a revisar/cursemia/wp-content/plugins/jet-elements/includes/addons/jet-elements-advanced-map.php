	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			array(
				...
				'description' => esc_html__( 'To get an address from latitude and longitude coordinates, combine coordinates names with ";" sign. For example: lat;lng. Latitude field always should be first. Latitude value range from -90 to 90. Longitude value outside range from -180 to 180.', 'jet-elements' ),
		...
		$this->add_control(
			...
			array(
				...
				'description' => esc_html__( 'To get an address from latitude and longitude coordinates of dms format, combine coordinates names with ";" sign. For example: 51° 30\' 12.2364" N;0° 7\' 10.2684" W. Latitude field always should be first.', 'jet-elements' ),
				'type'        => Controls_Manager::TEXT,
		...
		$repeater->add_control(
			...
			array(
				...
				'description' => esc_html__( 'To get Pin Address from latitude and longitude coordinates, combine coordinates names with ";" sign. For example: lat;lng. Latitude field always should be first. Latitude value range from -90 to 90. Longitude value outside range from -180 to 180.', 'jet-elements' ),
				'type'        => Controls_Manager::TEXT,
				'placeholder' => $default_lat_long,
				'default'     => $default_lat_long,
				'label_block' => true,
		...
		$repeater->add_control(
			...
			array(
				'label'       => esc_html__( 'Pin Address Coordinates', 'jet-elements' ),
				'description' => esc_html__( 'To get Pin Address from latitude and longitude coordinates of dms format, combine coordinates names with ";" sign. For example: 51° 30\' 12.2364" N;0° 7\' 10.2684" W. Latitude field always should be first.', 'jet-elements' ),
				'type'        => Controls_Manager::TEXT,
				'placeholder' => $default_dms_lat_long,
				'default'     => $default_dms_lat_long,
				'label_block' => true,
