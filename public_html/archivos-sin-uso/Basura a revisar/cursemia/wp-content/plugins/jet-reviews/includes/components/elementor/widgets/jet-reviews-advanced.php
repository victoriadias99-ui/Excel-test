	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			array(
				...
				'default' => '#bec0c1',
				'selectors' => array(
					'{{WRAPPER}} ' . $css_scheme['rating-field'] . ' .jet-reviews-stars--empty i' => 'color: {{VALUE}}',
	...
	protected function render() {
		...
		$instance_settings = array(
			...
			'icons'        => array(
				...
				'prevIcon'                => $settings[ 'prev_icon' ],
				'nextIcon'                => $settings[ 'next_icon' ],
			),
			'labels'       => array(
