...
class Post_Types extends Page_Module_Base {
	...
	public function get_page_name() {
		return esc_html__( 'Post Types', 'jet-reviews' );
	}
	...
	public function page_templates( $templates = array(), $page = false, $subpage = false ) {
		...
		$templates['jet-reviews-post-types'] = jet_reviews()->plugin_path( 'templates/admin-templates/post-types.php' );
