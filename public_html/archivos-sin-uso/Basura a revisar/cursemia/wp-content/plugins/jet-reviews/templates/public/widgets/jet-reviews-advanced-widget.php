			...
			>
				<div class="jet-reviews-advanced__header-top">
					<div class="jet-reviews-advanced__header-info">
						...
						></div>
						<div
							v-if="currentUserData.canReview"
						...
						<span class="jet-reviews-message" v-if="!currentUserData.canReview">{{ currentUserData.canReviewMessage }}</span>
					</div>
