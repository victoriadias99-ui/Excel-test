...
<div class="jet-woo-product-gallery__content">
	<div class="jet-woo-product-gallery-grid col-row">
		...
		if ( has_post_thumbnail( $product_id ) ) {
			...
			printf(
				'<div class="jet-woo-product-gallery__image-item featured no-image %s"><div class="jet-woo-product-gallery__image image-with-placeholder"><img src="%s" alt="%s" class="%s" /></div></div>',
