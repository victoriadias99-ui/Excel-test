...
if ( ! has_post_thumbnail( $product_id ) ) {
	$thumbs_html .= '<div class="jet-woo-product-gallery__image-item featured no-image swiper-slide"><div class="jet-woo-product-gallery__image image-with-placeholder"><img src="' . wc_placeholder_img_src() . '" alt="' . esc_html__( 'Placeholder', 'jet-woo-product-gallery' ) . '" class="wp-post-image" /></div></div>';
}
...
<div class="swiper-gallery-thumb">
	<div <?php $this->print_render_attribute_string( 'thumbs' ); ?>>
		...
		<?php echo $this->get_slider_navigation( 'pagination_thumbnails_slider_arrow_prev', 'pagination_thumbnails_slider_arrow_next' ); ?>
	</div>
</div>
