...
<html>
    ...
    <body style="font-family:montserrat_regular">
        ...
        <div class="pt-5">
            <div class="container">
                <div class="row">
                    <div class="col-md-4  mr-auto order-2 order-md-1"> <img class="img-fluid d-block" src="img/excelinicial.jpg"> </div>
                    <div class="px-md-5 p-3 d-flex flex-column align-items-start justify-content-center col-md-7 order-1 order-md-2" style="">
                        <h3 class="mb-3" style="font-family: montserrat_bold">Dominá a fondo esta herramienta y adquirí un conocimiento <span class="bg-success text-white px-2">imprescindible</span> en la actualidad</h3>
                ...
                <div class="row">
                    <div class="col-md-6 order-md-2 px-0 px-md-4" style="padding: 80px 20px 20px;">
                        ...
                        <div class="row mt-5 mx-auto" id="gr">
                            <div class="col-md-4">
                                <img class="img-fluid d-block mx-auto" src="../a-img/badge1.jpg" draggable="true">
                                <p class="pi-draggable text-center" draggable="true">Protegemos tu privacidad</p>
                            </div>
                            <div class="col-md-4">
                                <img class="img-fluid d-block mx-auto" src="../a-img/badge2.jpg">
                                <p class="pi-draggable text-center" draggable="true">Tus datos están seguros</p>
                            </div>
                            <div class="col-md-4">
                                <img class="img-fluid d-block mx-auto" src="../a-img/badge3.jpg">
                    ...
                    <div class="order-md-2 border rounded bg-light my-5 py-5 px-md-4 col-md-5" style="">
                        ...
                        <ul class="list-group mt-4">
                            <li class="list-group-item d-flex justify-content-between">
                                <div>
                                    <h6 class="my-0"><b>Excel Inicial</b></h6> <small class="text-muted">Acceso de por vida</small>
    ...
    <div class="py-5 text-center">
        <div class="container">
            ...
            <div class="row text-center">
                ...
                <div class="col-md-4 text-center">
                    <a class="" href="https://api.whatsapp.com/send?phone=5491168787291&amp;text=Hola!%20Te%20escribo%20por%20el%20curso%20de%20Excel"> <img class="img-fluid d-block  mx-auto" src="../a-img/whatsapp.jpg"> </a>
                </div>
                <div class="col-md-4 text-center">
                </div>
            </div>
