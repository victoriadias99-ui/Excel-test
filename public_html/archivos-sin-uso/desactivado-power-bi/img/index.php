            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-md-2 col-sm-6 col-6 logo">
                        <a href="power-bi" target="_blank"><img src="../a-img/logowhite.png" alt="logo" class="img-fluid"> </a>
                    </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-5" style="">
                        <div class=" py-auto">
                            <img src="img/powerbi.gif" class="img-fluid my-auto py-auto align-items-center justify-content-center pt-5 pt-md-5 mt-md-5" alt="curso de power bi">
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="section-heading ">
                            ...
                            <h1 class="mt-4  " style=""><b>APRENDÉ <span style="font-family: montserrat_black ;">POWER BI</span></b></h1>
                        </div>
                        <div class="feature-list mt-4">
                            <ul class="font-weight-light" style="font-family: montserrat_light ;">
                                <li class="wow fadeIn  animated" data-wow-delay="0.1" style="visibility: visible;-webkit-animation-delay: 0.1; -moz-animation-delay: 0.1; animation-delay: 0.1;"><i class="fas fa-check-circle text-dark"></i> 3 hs de video paso a paso</li>
                                ...
                                <li class="wow fadeIn animated" data-wow-delay="0.3" style="visibility: visible;-webkit-animation-delay: 0.3; -moz-animation-delay: 0.3; animation-delay: 0.3;"><i class="fas fa-check fa-check-circle text-dark"></i> Creado por un profesor de la UTN <span style="font-family: montserrat_bold; color:black;">(Universidad Técnica Nacional)</span></li>
                            </ul>
                            <h3 class="mt-md-4 p-2 mt-3 col-8 col-md-6 text-center" style="background-color:#f3c910; color:black;font-family: montserrat_regular;"><strike>$4.999</strike><span class="font-weight-bold "> $1.999</span></h3>
                        ...
                        <div class="review-one mt-5 mt-md-3">
                            <div class="review-text">
                                <h5 style="font-family: montserrat_regular" class="font-weight-light">"Recomiendo este curso a quien quiera aprender una nueva habilidad. No lo conocía y me resultó fácil de entender"</h5>
                            </div>
                            <div class="review-image">
                                <p class="user_name d-inline" style="font-family: montserrat_bold;">Ariel Bustamante<i class="ml-3 fa fa-star" style="color:#ffd322;"></i>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-9 px-md-5 mx-auto" style="">
                        ...
                        <p class="font-weight-light lead mb-4"><span style="background-color:#f3c910; color:black;font-family: montserrat_bold;" class="p-1">Microsoft Power BI</span> es una herramienta usada para la Inteligencia Empresarial. Permite unir diferentes fuentes de datos y volcarlos
                            en tableros que pueden ser consultados de forma rápida e intuitiva, facilitando el conocimiento y toma de decisiones dentro de una empresa, <b>ahorrando muchísimas horas de trabajo.</b>

                        <p class="lead mb-4">A través de este curso vas a aprender a conocer todas las funciones de Power BI, realizar tableros, análisis de datos y mucho más. Explicado paso a paso en 3 horas de videos por un profesor certificado de la <span style="background-color:black; color:white;"
                                                                                                                                                                                                        class="p-1 font-w">Universidad Tecnológica Nacional (UTN)</span><br></p>
                        <hr>
                        <p class="lead" style=""> Requsitos: una PC con Power BI instalado (es gratuito)<br></p>
                        <div class="call-button mt-5">
                            ...
                            <p class="user_name d-inline pl-4 pr-4 font-weight-light">+1200 estudiantes</p>
                        </div>
                    </div>
        ...
        <div class="py-5 bg-dark text-white   ">
            <div class="container ">
                <div class="row mx-auto">
                    <div class="col-lg-5 col-md-6 p-md-4   mx-0 px-0 "> <img class="img-fluid d-block rounded shadow  " src="img/laptopconlogo2.jpg" width="1500"> </div>
                    <div class="col-md-6 offset-lg-1 d-flex flex-column justify-content-center py-4">
                        ...
                        <ul class="mx-auto mx-md-1 lead">
                            <li><i class="fas fa-check " style="color:#f3c910;"></i> Metodología para el análisis de datos</li>
                            ...
                            <li><i class="fas fa-check  " style="color:#f3c910;"></i> Rapidez para crear nuestros análisis</li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="container my-3">
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 p-4 text-center">
                        ...
                        <p class="mb-3"><i>"</i>Muy detallado con ejemplos claros. Soy nuevo en Power BI y aprendí desde cero<i>"</i> </p>
                        <p class="mb-1"> <b>Agustín Rodriguez</b></p>
                    ...
                    <div class="col-lg-4 col-md-6 p-4 text-center">
                        ...
                        <p class="mb-3">"Excelente curso de Power BI. Tenia algo de experiencia en esto y me ayudo a asentar algunas bases. Lo recomiendo totalmente para nuevos usuarios"&nbsp;&nbsp;</p>
                        <p class="mb-1"> <b>Osvaldo Nevada</b></p>
                        <div class="rating-user d-inline">
                            <i class="fa fa-star"></i>
                            <i class="fa fa-star"></i>
                            <i class="fa fa-star"></i>
                    ...
                    <div class="col-lg-4 p-4 text-center">
                        ...
                        <p class="mb-1"> <b>Matías Testa</b></p>
                        <div class="rating-user d-inline">
                            <i class="fa fa-star"></i>
                            <i class="fa fa-star"></i>
                            <i class="fa fa-star"></i>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-4 col-md-6 p-4 text-center">
                        ...
                        <p class="mb-1"> <b>Silvana Amaya</b></p>
                        <div class="rating-user d-inline">
                            <i class="fa fa-star"></i>
                            <i class="fa fa-star"></i>
                            <i class="fa fa-star"></i>
                    ...
                    <div class="col-lg-4 col-md-6 p-4 text-center">
                        ...
                        <p class="mb-3">"Da muy buenas bases para seguir incursionando en la herramienta. Espero el próximo curso"</p>
                    ...
                    <div class="col-lg-4 p-4 text-center">
                        ...
                        <p class="mb-3"> "Empecé sin concomientos y ya lo estoy implementando en algunas áreas pequeñas de mi trabajo. Los videos son muy claros y la atención que me dieron con mis dudas fué rápida"</p>
            ...
            <div class="container">
                ...
                <div class="accordion mt-4" id="accordionExample">
                    ...
                    <div class="card">
                        ...
                        <div id="collapseFive" class="collapse" aria-labelledby="headingFive" data-parent="#accordionExample" style="">
                            <div class="card-body">Tener instalado el programa Power BI. Es gratuito, y te podemos ayudar con la instalación</div>
                        </div>
                    </div>
                    <div class="card">
                        <div class="card-header" id="headingSix">
        ...
        <section class="bottom-product bg-light" style="">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-md-5">
                        <div class="">
                            <img src="img/curso-power-bi.jpg" class="img-fluid rounded shadow" alt="product">
                        </div>
                    </div>
                    <div class="col-md-1">&nbsp;</div>
                    <div class="col-md-6" style="">
                        <div class="section-heading">
                            ...
                            <h1 class="font-weight-bold text-left" style="font-family: montserrat_black">Sumá POWER BI a tu CV</h1>
                        </div>
                        <div class="feature-list mt-4">
                            <p> • Pago por única vez en Pesos Argentinos (sin suscripciones ni pagos mensuales). <br>• Garantía de devolución de 7 días</p>
                            <h3 class="mt-md-4 p-2 mt-3 col-8 col-md-6 text-center" style="background-color:#f3c910; color:black;font-family: montserrat_bold;"><strike>$4.999</strike><span class="font-weight-bold "> $1.999</span></h3>
                        </div>
                        <div class="call-button mt-5">
                            <div class="row">
                                <div class="col-md-6">
