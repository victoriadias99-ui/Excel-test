...
<html>
    ...
    <body style="font-family: 'Raleway Regular';">
        <?php
        $headerImagen = "assets/img/prueba.png";
            ...
            <div class="container">
                <div class="row p-4 p-md-0">
                    <div class="col-md-7 flex-column">
                        <div class="row">
                            <div class="col-md-5">
                                <img class="img-fluid rounded" src="../petroleo/assets/img/petro1.jpg">
                            </div>
                            <div class="col-md-7 mt-4 mt-md-0">
                                <h5><b>Estás a unos clics de tener tu curso...</b></h5>
                                <h3><b>Domina Petróleo y Gas</b></h3>
                                <p class="mb-3">Aprendé y dominá Petróleo y Gas</p>
                            </div>
                        </div>
                        ...
                        <div class="row mt-5">
                            <div class="col-4 p-1">
                                <div class="card-scv p-2 text-center">
                                    <img src="../n-img/badge1_.jpg" class="p-1"><br>
                                    <span>Protegemos tu privacidad</span>
                                </div>
                            </div>
                            <div class="col-4 p-1">
                                <div class="card-scv p-2 text-center">
                                    <img src="../n-img/badge2_.jpg" class="p-1"><br>
                                    <span>Tus datos están seguros</span>
                                </div>
                            </div>
                            <div class="col-4 p-1">
                                <div class="card-scv p-2 text-center">
                                    <img src="../n-img/badge3_.jpg" class="p-1"><br>
