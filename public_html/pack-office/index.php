        ...
        <section>
            <div class="row">
                <div class="col-md-7 px-5 ">
                    ...
                    <h1 style="font-family: 'Raleway Black'; color:#00173B;">Realiza el PACK OFFICE</h1>
                    ...
                    <div class="d-block d-md-none mt-3">
                        ...
                        <p class="d-flex align-items-center m-0"><span class="texto-precio-head mr-2" style="font-family: Montserrat, sans-serif;font-weight: bold;color: #007DD6;"><?=$precioCurso?><br></span><span class="texto-moneda-head" style="font-family: 'Raleway Light';font-weight: bold;color: #007DD6;"><?=$moneda?><br></span></p>
                        ...
                        <p class="mt-4" style="color: rgb(85,85,85);font-family: 'Raleway Regular';">Aprende Word, Excel y PowerPoint en solo 9 horas y consigue las mejores oportunidades.</p>
...
<br></li>
                        <li><i class="fa fa-check" style="color: #007DD6;"></i>&nbsp;+ 30 Ejercicios Prácticos
<br></li>
<li><i class="fa fa-check" style="color: #007DD6;"></i>&nbsp;5 Plantillas Gratis de Balances y Reportes
<br></li>
...
pero puede ser tuyo con esta oferta limitada por sólo: </p>
                    <div class="d-xl-flex align-items-xl-center p-3" style="border-radius: 10px;background: #ffffff;border: 1px solid #bcbcbc ;">
                        <div class="col m-0">
                            <p class="d-xl-flex align-items-xl-center m-0"><span class="texto-precio-head mr-2" style="font-family: Montserrat, sans-serif;font-weight: bold;color: #007DD6;"><?=$precioCurso?><br></span><span class="texto-moneda-head" style="font-family: 'Raleway Light';font-weight: bold;color: #007DD6;"><?=$moneda?><br></span></p>
                            <p style="color: #FF0000;font-family: 'Raleway SemiBold';"><strike><?=$precioCursoOficial?> <?=$moneda?></strike></p>
                        </div>
                    </div>
...
<br></li>
                        <li>Requsitos:<br>una PC con los programas Word, Excel y Powerpoint instalados (es gratuito)</li>
                    </ul>
...
<div class="col-md-6">
            <h1 style="font-family: 'Raleway Black';">¿Querés conocer el temario completo?</h1>
            <div class="card">
