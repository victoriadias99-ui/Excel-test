            ...
            <div class="container">
                <div class="row p-4 p-md-0">
                    <div class="col-md-7 flex-column">
                        <div class="row">
                            <div class="col-md-5">
                                <img class="img-fluid rounded" src="../pack-office/assets/img/imagen-header.png">
                            </div>
                            <div class="col-md-7 mt-4 mt-md-0">
                                <h5><b>Estás a unos clics de tener tu curso...</b></h5>
                                <h3><b>Pack Office</b></h3>
                                <p class="mb-3">Llevá tu conocimientos a un nivel completo 🏆</p>
                            </div>
                        </div>
                            ...
                            <div class="col-12">
                                <div class="feature-list">
                                    <ul class="pl-0 px-md-3  px-0" style="list-style: none">
                                        ...
                                        <li class="text-dark"> <i class="fas fa-check-circle" ></i>Más de 15.500 alumnos/as en Aprende Excel</li>
                                    </ul>
                                </div>
                            </div>
