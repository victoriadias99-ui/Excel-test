...
include("../n-includes/funcionsDB.php"); //Se incluyen las funciones para obtener los datos de la DB
include("../n-includes/logicparametros.php"); //Se incluyen las funciones para obtener el funcinamiento de la localización del cliente 
$data = getCursoDetalleCheckout($idcurso); // se obtiene toda la información del curso
...
/*
  ...
  echo "</pre>";
 */
$curso = $data['producto']; // Se obtiene los datos del producto
//PRECIO_UNITARIO
$value = $curso['PRECIO_UNITARIO']; // Precio que pagará el cliente 
$precioDescuento = $value;
$precioCursoDescuento = '$' . $value . ' ARS'; // Formato precio que pagará el cliente 
...
$diferencia = '$' . (intval(($value / $curso['PORCENTAJE_DES']) * 100) - $value) . ' ARS'; // Diferencia entre el precio original y el descuento
?>
<!DOCTYPE html>
<html>
    <head>
    ...
    <body style="font-family: 'Raleway Regular';">
        ...
        <div class="pt-5">
            <div class="container">
                <div class="row">
                    <div class="col-md-4  mr-auto order-2 order-md-1"> <img class="img-fluid d-block" src="../n-img/excelavanzado4.jpeg"> </div>
                ...
                <div class="row p-3">
                    <div class="col-md-5 mx-auto  my-auto" style="padding: 80px 20px;">
                        ...
                        <ul class="list-group">
                            ...
                            <li class="list-group-item d-flex justify-content-between text-dark"> <span>Total</span>
                                <b id="total_price"><?= $precioCursoDescuento ?></b>
                            </li>
                        </ul>
                    ...
                    <div class="col-md-6 order-md-2 my-auto col-xl-5 " id="arriba">
                        ...
                        <div class="col-md-10 mx-auto text-dark rounded pb-5 py-5 px-md-4 px-xs-2 px-sm-2  bg-white mt-3">
                            <div class="text-center "> <img width="100%" alt="Mercado Pago - Medios de pago" title="Mercado Pago - Medios de pago" src="https://imgmp.mlstatic.com/org-img/banners/ar/medios/online/468X60.jpg"></div>
                            <div class="row">
