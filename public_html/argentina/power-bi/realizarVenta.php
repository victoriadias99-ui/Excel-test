...
try {   
	...
	$preference->notification_url = "https://excel-facil.com/power-bi/IPN_mp.php?curso=$curso";
  ...
  "excluded_payment_types" => array(array("id" => "ticket")));
    ...
    "success" => "https://excel-facil.com/power-bi/pago_exitoso.html",
    "failure" => "https://excel-facil.com/power-bi/pago_en_proceso.html",
    "pending" => "https://excel-facil.com/power-bi/pago_en_proceso.html");
	}
	
	if($curso == 'upsell_pbi_y_avanzado')
	{
		$preference->back_urls = array(
        "success" => "https://excel-facil.com/power-bi/pago_exitoso_up.html",
        "failure" => "https://excel-facil.com/power-bi/pago_en_proceso.html",
        "pending" => "https://excel-facil.com/power-bi/pago_en_proceso.html");
	}
