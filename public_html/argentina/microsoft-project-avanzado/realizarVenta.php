...
try {   
	...
	$preference->notification_url = "https://excel-facil.com/microsoft-project-avanzado/IPN_mp.php?curso=$curso";
	$preference->payment_methods = array(
  "excluded_payment_methods" => array(array("id" => "rapipago"),array("id" => "pagofacil")),
  "excluded_payment_types" => array(array("id" => "ticket")));
	if($curso == 'project_avanzado')
	{
		$preference->back_urls = array(
    	"success" => "https://excel-facil.com/microsoft-project-avanzado/pago_exitoso.html",
    	"failure" => "https://excel-facil.com/microsoft-project-avanzado/checkout.html",
    	"pending" => "https://excel-facil.com/microsoft-project-avanzado/checkout.html");
	}
	
	if($curso == 'upsell_project_avanzado')
	{
		$preference->back_urls = array(
    	"success" => "https://excel-facil.com/microsoft-project-avanzado/pago_exitoso_1y3.html",
    	"failure" => "https://excel-facil.com/microsoft-project-avanzado/checkout.html",
    	"pending" => "https://excel-facil.com/microsoft-project-avanzado/checkout.html");
	}
	...
	{
		$preference->back_urls = array(
    	"success" => "https://excel-facil.com/microsoft-project-avanzado/pago_exitoso_2y3.html",
    	"failure" => "https://excel-facil.com/microsoft-project-avanzado/checkout.html",
    	"pending" => "https://excel-facil.com/microsoft-project-avanzado/checkout.html");
	}
	...
	{
		$preference->back_urls = array(
    	"success" => "https://excel-facil.com/microsoft-project-avanzado/pago_exitoso_1y2y3.html",
    	"failure" => "https://excel-facil.com/microsoft-project-avanzado/checkout.html",
    	"pending" => "https://excel-facil.com/microsoft-project-avanzado/checkout.html");
	}
