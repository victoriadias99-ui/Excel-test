...
try {   
	...
	$preference->notification_url = "https://excel-facil.com/pack-office/IPN_mp.php?curso=$curso";
  ...
  "excluded_payment_types" => array(array("id" => "ticket")));
    ...
    "success" => "https://excel-facil.com/pack-office/pago_exitoso.html",
    "failure" => "https://excel-facil.com/pack-office/pago_en_proceso.html",
    "pending" => "https://excel-facil.com/pack-office/pago_en_proceso.html");
	}
	
	if($curso == 'upsell_office_y_intermedio')
	{
		$preference->back_urls = array(
        "success" => "https://excel-facil.com/pack-office/pago_exitoso_up.html",
        "failure" => "https://excel-facil.com/pack-office/pago_en_proceso.html",
        "pending" => "https://excel-facil.com/pack-office/pago_en_proceso.html");
	}
