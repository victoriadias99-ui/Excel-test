            ...
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-md-3 cta-button  col-sm-6 col-6">
                        <a class="hvr-sweep-to-right text-white" href="checkout.php">Lo quiero</a>
                    </div>
                </div>
            </div>
        </header>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-5" style="">
                        <div class="">
                            <img src="img/banner.jpg" class="img-fluid" alt="product">
                        </div>
                    </div>
                    <div class="col-md-1">&nbsp;</div>
                    <div class="col-md-6">
                        <div class="section-heading">
                            <h3 style="color:black;" style="font-family: montserrat_bold;">Dominá Excel en profundidad</h3>
                            <h2 class="mt-4" style="font-family: montserrat_bold;"><b>Curso online Nivel Intermedio </b></h2>
                        </div>
                        <div class="feature-list mt-4">
                            <ul style="">
                                <li class="wow fadeIn   animated" data-wow-delay="0.1" style="visibility: visible;-webkit-animation-delay: 0.1; -moz-animation-delay: 0.1; animation-delay: 0.1;"><i class="fas fa-check text-success "></i> 4hs de video paso a paso</li>
                        ...
                        <div class="review-one mt-5">
                            <div class="review-text">
                                <h5>"Agradezco al profesor nuevamente por la manera de transmitir el conocimiento. Muy bien explicado"</h5>
                            </div>
                            <div class="review-image">
                                <p class="user_name d-inline">Alejo Fernandez <i class="ml-3 fa fa-star" style="color:#ffd322;"></i>
            ...
            <div class="container">
                <div class="row">
                    <div class="mx-auto col-md-12">
                        <h3 class="text-white display-4" style="font-family: montserrat_bold;">Dominá Excel en profundidad</h3>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-9 px-md-5 mx-auto" style="">
                        <p class="lead mb-4">A través de este curso vas a aprender a dominar Microsoft Excel hasta un nivel intermedio, consiguiendo dominar la mayoría de sus funciones generales y avanzadas de esta herramienta. Explicado paso a paso en 4 horas de videos.<br></p>
                        <hr>
                        <p class="lead" style="">Requisitos: conocimientos básicos de Excel (si no los tenés, debés comenzar por nuestro curso Nivel Inicial)<br></p>
                        <div class="call-button mt-5">
                            ...
                            <p class="user_name d-inline pl-4 pr-4">+15000 Estudiantes</p>
                        </div>
                    </div>
        ...
        <div class="py-5 bg-dark text-white   ">
            <div class="container ">
                <div class="row mx-auto">
                    <div class="col-lg-5 col-md-6 p-md-4   mx-0 px-0 "> <img class="img-fluid d-block img-thumbnail rounded shadow  " src="img/laptopconlogo2.jpg" width="1500"> </div>
                    <div class="col-md-6 offset-lg-1 d-flex flex-column justify-content-center py-4">
                        ...
                        <ul class="mx-auto mx-md-1">
                            <li><i class="fas fa-check text-success "></i> Armar tablas dinámicas</li>
                            <li><i class="fas fa-check text-success "></i> Crear plantillas para gráficos</li>
                            <li><i class="fas fa-check text-success "></i> Filtros avanzados</li>
                            <li><i class="fas fa-check text-success "></i> Funciones avanzadas</li>
                            <li><i class="fas fa-check text-success "></i> Creación de paneles/dashboards</li>
                            <li><i class="fas fa-check text-success "></i> Ejecutar y automatizar Macros</li>
                            <li><i class="fas fa-check text-success "></i> Casos prácticos </li>
                        </ul>
                    ...
                    <div class="col-lg-4 p-3">
                        <div class="card">
                            <div class="card-body p-4"> <img class="img-fluid d-block mb-3 mx-auto rounded-circle" src="img/certificado.jpg" width="150">
                                <h4 style="font-family: montserrat_bold;">Certificado</h4>
                    ...
                    <div class="col-lg-4 p-3 col-md-6">
                        <div class="card">
                            <div class="card-body p-4"> <img class="img-fluid d-block mb-3 mx-auto rounded-circle" src="img/soporte.jpg" width="150">
                                <h4 style="font-family: montserrat_bold;">Soporte </h4>
                    ...
                    <div class="col-lg-4 p-3 col-md-6">
                        <div class="card">
                            <div class="card-body p-4"> <img class="img-fluid d-block mb-3 mx-auto rounded-circle" src="img/acceso.jpg" width="150">
                                <h4 style="font-family: montserrat_bold;">Acceso de por vida</h4>
        ...
        <div class="py-5 bg-dark text-white" id="ch">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 p-4 text-center">
                        <div class="review-image text-center mt-3 mb-3">
                            <img src="img/reviews/marianopintos.jpg" alt="review" class="d-inline">
                        </div>
                ...
                <div class="accordion mt-4" id="accordionExample">
                    ...
                    <div class="card">
                        ...
                        <div id="collapseTwo" class="collapse" aria-labelledby="headingThree" data-parent="#accordionExample" style="">
                            <div class="card-body">4hs de videos es la duración total del curso.</div>
                        </div>
                    </div>
                    <div class="card">
        ...
        <section class="bottom-product bg-light" style="">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-md-5">
                        <div class="">
                            <img src="img/banner2_.jpg" class="img-fluid" alt="product">
                        </div>
                    </div>
                    <div class="col-md-1">&nbsp;</div>
                    <div class="col-md-6" style="">
                        <div class="section-heading">
                            ...
                            <h2 class="font-weight-bold text-left" style="font-family: montserrat_bold;">Dominá Excel en profundidad</h2>
                        </div>
                        <div class="feature-list mt-4">
