...
try {   
	...
	$item->picture_url = "http://aprende-excel.com/curso1/img/logojpg.jpg";
	...
	if(count($rows_descuento)>0)
	{
		...
		$itemdesc->picture_url = "http://aprende-excel.com/curso1/img/logojpg.jpg";		
	...
	$preference->notification_url = "http://aprende-excel.com/curso2/IPN_mp.php?curso=$curso";
  ...
  "excluded_payment_types" => array(array("id" => "ticket")));
    ...
    "success" => "http://aprende-excel.com/curso2/pago_exitoso.html",
    "failure" => "http://aprende-excel.com/curso2/pago_en_proceso.html",
    "pending" => "http://aprende-excel.com/curso2/pago_en_proceso.html");
