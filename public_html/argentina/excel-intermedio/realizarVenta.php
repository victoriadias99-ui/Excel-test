...
try {   
	...
	$preference->notification_url = "https://excel-facil.com/excel-intermedio/IPN_mp.php?curso=$curso";
	$preference->payment_methods = array(
  "excluded_payment_methods" => array(array("id" => "rapipago"),array("id" => "pagofacil")),
  "excluded_payment_types" => array(array("id" => "ticket")));
	
    if($curso == 'excel_intermedio')
	{
    $preference->back_urls = array(
    	"success" => "https://excel-facil.com/excel-intermedio/pago_exitoso.html",
    "failure" => "https://excel-facil.com/excel-intermedio/pago_en_proceso.html",
    "pending" => "https://excel-facil.com/excel-intermedio/pago_en_proceso.html");
	}
	
	if($curso == 'upsell_intermedio_y_avanzado')
	{
		$preference->back_urls = array(
    	"success" => "https://excel-facil.com/excel-intermedio/pago_exitoso_up.html",
    	"failure" => "https://excel-facil.com/excel-intermedio/pago_en_proceso_up.html",
    	"pending" => "https://excel-facil.com/excel-intermedio/pago_en_proceso_up.html");
	}
