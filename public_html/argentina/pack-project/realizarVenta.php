...
try {   
	...
	$preference->notification_url = "https://excel-facil.com/curso1/IPN_mp.php?curso=$curso";
	$preference->payment_methods = array(
  "excluded_payment_methods" => array(array("id" => "rapipago"),array("id" => "pagofacil")),
  "excluded_payment_types" => array(array("id" => "ticket")));
	if($curso == 'prom_project_pack')
	{
		$preference->back_urls = array(
    	"success" => "https://excel-facil.com/curso1/pago_exitoso.html",
    	"failure" => "https://excel-facil.com/curso1/pago_en_proceso_2.html",
    	"pending" => "https://excel-facil.com/curso1/pago_en_proceso_2.html");
	}
	
	if($curso == 'upsell_inicial_y_intermedio')
	{
		$preference->back_urls = array(
    	"success" => "https://excel-facil.com/curso1/pago_exitoso_1y2.html",
    	"failure" => "https://excel-facil.com/curso1/pago_en_proceso_1y2.html",
    	"pending" => "https://excel-facil.com/curso1/pago_en_proceso_1y2.html");
	}
