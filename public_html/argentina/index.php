...
<html>
    <head>
        ...
        <link rel="stylesheet" media="screen" href="vendor/css/vendor.min.css">
    ...
    <body style="margin-top: 0px; padding-top: 0px;">
        ...
        <nav class="navbar navbar-expand-lg fixed-top navbar-light bg-light shadow-sm p-0 mb-0 bg-white">
            <div class="container-fluid">
                <a class="navbar-brand mr-5" href=""><img class="img-responsive" src="assets/img/logojpg.jpg" alt="Logo" class=""></a>
                    ...
                    <ul class="navbar-nav me-auto mb-lg-0">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu px-2" aria-labelledby="navbarDropdown1">
                                <a class="nav-link dropdown-item" href="a-excel-inicial/">Excel Nivel Inicial</a>
                                <a class="nav-link dropdown-item" href="a-excel-intermedio/">Excel Nivel Intermedio</a>
                                <a class="nav-link dropdown-item" href="a-excel-avanzado/">Excel Nivel Avanzado</a>
                                <a class="nav-link dropdown-item" href="a-excel-promo">Excel promo 3 en 1</a>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu px-2" aria-labelledby="navbarDropdown2">
                                <a class="nav-link dropdown-item" href="a-power-bi">Power BI Nivel Inicial</a>
                                <a class="nav-link dropdown-item" href="a-power-bi-avanzado">Power BI Avanzado</a>
                                <a class="nav-link dropdown-item" href="a-power-bi-y-excel">Power BI + Excel 3 en 1</a>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu px-2" aria-labelledby="navbarDropdown3">
                                <a class="nav-link dropdown-item" href="a-excel-inicial/">Microsoft Excel</a>
                                <a class="nav-link dropdown-item" href="a-word/">Microsoft Word</a>
                                <a class="nav-link dropdown-item" href="a-power-point/">Microsoft Power Point</a>
                                <a class="nav-link dropdown-item" href="a-pack-office/">Pack Office promo 3 en 1</a>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu px-2" aria-labelledby="navbarDropdown5">
                                <a class="nav-link dropdown-item" href="a-visual-studio/">Visual Studio en C#</a>
                                <a class="nav-link dropdown-item" href="a-microsoft-sql-server/">Base de datos con SQL SERVER</a>
                            </div>
                        </li>
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown5" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            ...
                            <div class="dropdown-menu px-2" aria-labelledby="navbarDropdown5">
                                <a class="nav-link dropdown-item" href="a-microsoft-project-inicial">Gerencia De Proyectos Inicial</a>
                                <a class="nav-link dropdown-item" href="a-microsoft-project-intermedio">Gerencia De Proyectos Intermedio</a>
                                <a class="nav-link dropdown-item" href="a-microsoft-project-avanzado">Gerencia De Proyectos Avanzado</a>
                                <a class="nav-link dropdown-item" href="a-pack-project/">Gerencia De Proyectos 3 en 1 Promo</a>
                            </div>
                        </li>
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown5" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            ...
                            <div class="dropdown-menu px-2" aria-labelledby="navbarDropdown5">
                                <a class="nav-link dropdown-item" href="a-windows-server/">Windows Server</a>
                                <a class="nav-link dropdown-item" href="a-petroleo/">Introducción al Petróleo</a>
                                <a class="nav-link dropdown-item" href="a-google-sheets/">Google Sheets</a>
        ...
        <!-- Page Content-->
        <!-- Hero-->
        <div class="py-5 mt-5 text-center text-md-right" style="	background-image: linear-gradient(to bottom, rgba(0, 0, 0, 0.2), rgba(0, 0, 0, 0.9)), url(&quot;assets/img/fondtop.jpg&quot;);	background-position: top left, center;	background-size: 100%, cover;	background-repeat: repeat, repeat;	background-attachment: fixed;">
        ...
        <!-- CTA #1-->
        <section class="py-5 " style="	background-color: #;	background-image: url(&quot;assets/img/fondo3.jpg&quot;);	background-position: top left;	background-size: 100%;	background-repeat: no-repeat;" id="gr">
            <div class="container-fluid">
                <div class="row align-items-center">
                    <div class="col-xl-5 col-md-6 offset-xl-1"><img class="d-block mx-auto img-thumb border rounded img-thumbnail" src="assets/img/laptopconlogo.jpg" alt="CreateX Marketing"></div>
        ...
        <section class="py-3 " style="	background-color: #;	background-image: url(&quot;assets/img/fondo3.jpg&quot;);	background-position: top left;	background-size: 100%;	background-repeat: no-repeat;" id="ch">
            <div class="container-fluid">
                <div class="row align-items-center">
                    <div class="col-xl-5 col-md-6 offset-xl-1"><img class="d-block mx-auto img-thumb border rounded img-thumbnail" src="assets/img/laptopconlogo.jpg" alt="CreateX Marketing"></div>
                    <div class="col-xl-5 col-md-6 text-center text-md-left py-5" style="">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-4 p-3">
                        <div class="card">
                            <div class="card-body p-4"> <img class="img-fluid d-block mb-3 mx-auto rounded-circle" src="assets/img/certificado.jpg" width="150">
                    ...
                    <div class="col-lg-4 p-3 col-md-6">
                        <div class="card">
                            <div class="card-body p-4"> <img class="img-fluid d-block mb-3 mx-auto rounded-circle" src="assets/img/soporte.jpg" width="150">
                                <h4>Soporte </h4>
                    ...
                    <div class="col-lg-4 p-3 col-md-6">
                        <div class="card">
                            <div class="card-body p-4"> <img class="img-fluid d-block mb-3 mx-auto rounded-circle" src="assets/img/acceso.jpg" width="150">
        ...
        <section class="container py-3 mt-3">
            ...
            <section class="container py-5 mb-3 col-md-12">
                ...
                <div class="row pt-4 justify-content-center">
                    ...
                    <div class="card portfolio-card col-md-3 col-sm-6 mb-30 pb-2"> <img src="assets/img/excelinicial.jpg" alt="Portfolio Thumbnail">
                        <div class="card-body">
                        ...
                        <div class="card-footer">
                            <div><a class="tag-link" href="/argentina/a-excel-inicial/">Sin requisitos previos, éste curso te va a enseñar a usar Microsoft Excel: la herramienta laboral más solicitada por las empresas.<br></a> 
                                <a class="btn btn-lg btn-block" href="/argentina/a-excel-inicial" style="background-color:#4eaf4e; color:white;" target="_blank">👉 Ver Curso</a></div>
                            <div class="portfolio-meta"> </div>
                        </div>
                    </div>
                    <!-- /div -->
                    <!-- div class="col-md-3 col-sm-6 mb-30 pb-2" -->
                    <div class="card portfolio-card col-md-3 col-sm-6 mb-30 pb-2"> <img src="assets/img/excelintermedio.jpg" alt="Portfolio Thumbnail" style="">
                        <div class="card-body">
                            <h5 class="portfolio-title">#2: Excel Nivel Intermedio</h5>
                        </div>
                        <div class="card-tag d-none">Excel</div>
                        <div class="card-footer">
                            <div><a class="tag-link" href="/argentina/a-excel-intermedio/" target="_blank">Entrenamiento para usuarios que ya tienen los conocimientos básicos de Microsoft Excel, para aprender en profundidad la mayoría de sus funcionalidades.<br></a>
                                <a class="btn btn-lg btn-block" href="/argentina/a-excel-intermedio" target="_blank" style="background-color:#4eaf4e; color:white;">👉 Ver Curso</a>
                            </div>
                        </div>
                    </div>
                    <!-- /div -->
                    <!-- div class="col-md-3 col-sm-6 mb-30 pb-2" -->
                    <div class="card portfolio-card col-md-3 col-sm-6 mb-30 pb-2"> <img src="assets/img/excelavanzado.jpg" alt="Portfolio Thumbnail" style="">
                        <div class="card-body">
                            <h5 class="portfolio-title">#3: Excel Nivel Avanzado</h5>
                        </div>
                        <div class="card-tag d-none">Excel</div>
                        <div class="card-footer">
                            <div><a class="tag-link" href="/argentina/a-excel-avanzado/" target="_blank">Curso para terminar de conocer Excel y dominar sus funcionalidades más avanzadas. Ser Experto en Excel otorga una gran ventaja y abre las puertas a empleos muy bien pagos.<br></a>
                                <a class="btn btn-lg btn-block" href="/argentina/a-excel-avanzado" target="_blank" style="background-color:#4eaf4e; color:white;">👉 Ver Curso</a>
                            </div>
                        </div>
                    </div>
                    <!-- div -->
                    <!-- div class="col-md-3 col-sm-6 mb-30 pb-2" -->
                    <div class="card portfolio-card col-md-3 col-sm-6 mb-30 pb-2"> <img src="/assets/img/google-sheets/google-sheets-1.jpg" alt="Portfolio Thumbnail" style="">
                        <div class="card-body">
                            <h5 class="portfolio-title">Google Sheets</h5>
                        </div>
                        <div class="card-tag d-none">Excel Google Sheets Otros</div>
                        <div class="card-footer">
                            <div><a class="tag-link" href="/argentina/a-google-sheets/" target="_blank">Dominá la herramienta de Hojas de Cálculo Online más utilizada del mercado<br></a>
                                <a class="btn btn-lg btn-block" href="/argentina/a-google-sheets/" target="_blank" style="background-color:#4eaf4e; color:white;">👉 Ver curso</a></div>
                        </div>
                    </div>
                    <!-- /div -->
                    <!-- div class="col-md-3 col-sm-6 mb-30 pb-2" -->
                    <div class="card portfolio-card col-md-3 col-sm-6 mb-30 pb-2"> <img src="assets/img/powerbi.jpg" alt="Portfolio Thumbnail" style="">
                        <div class="card-body">
                            <h5 class="portfolio-title">Microsoft Power BI</h5>
                        </div>
                        <div class="card-tag d-none">POWER BI</div>
                        <div class="card-footer">
                            <div><a class="tag-link" href="/argentina/a-power-bi/" target="_blank">Un especialista en Power BI gana un sueldo 3 vecess mayor a la media. Ésta herramienta de Inteligencia Empresarial permite crear tableros para visualizar datos. Sin requisitos previos<br></a>
                                <a class="btn btn-lg btn-block" href="/argentina/a-power-bi" target="_blank" style="background-color:#4eaf4e; color:white;">👉 Ver Curso</a>
                            </div>
                        </div>
                    </div>
                    <div class="card portfolio-card col-md-3 col-sm-6 mb-30 pb-2"> <img src="assets/img/powerbi-avanzado/powerbi-avanzado.jpg" alt="Portfolio Thumbnail" style="">
                        <div class="card-body">
                            <h5 class="portfolio-title">Microsoft Power BI Avanzado</h5>
                        </div>
                        <div class="card-tag d-none">POWER BI</div>
                        <div class="card-footer">
                            <div><a class="tag-link" href="/argentina/a-power-bi-avanzado/" target="_blank">Profundizá tus conocimientos a través de este Curso Avanzado de Power BI en 4.5 horas de curso<br></a>
                                <a class="btn btn-lg btn-block" href="/argentina/a-power-bi-avanzado/" target="_blank" style="background-color:#4eaf4e; color:white;">👉 Ver Curso</a>
                            </div>
                        </div>
                    </div>
                    <!-- /div -->
                    <!-- div class="col-md-3 col-sm-6 mb-30 pb-2" -->
                    <div class="card portfolio-card col-md-3 col-sm-6 mb-30 pb-2"> <img src="assets/img/excel-experto.jpg" alt="Portfolio Thumbnail" style="">
                        <div class="card-body">
                            <h5 class="portfolio-title">3 NIVELES - PACK EXPERTO</h5>
                        </div>
                        <div class="card-tag d-none">EXCEL</div>
                        <div class="card-footer">
                            <div><a class="tag-link" href="/argentina/a-excel-promo/" target="_blank">Convertite en un Experto en Excel con este pack de 3 cursos. ¡Sé el experto que las empresas están buscando!<br></a>
                                <a class="btn btn-lg btn-block" href="/argentina/a-excel-promo/" target="_blank" style="background-color:#4eaf4e; color:white;">👉 Ver Curso</a>
                            </div>
                        </div>
                    </div>
                    <!-- /div -->
                    <!-- div class="col-md-3 col-sm-6 mb-30 pb-2" -->
                    <div class="card portfolio-card col-md-3 col-sm-6 mb-30 pb-2"> <img src="assets/img/office/office2.jpeg" alt="Portfolio Thumbnail" style="">
                        <div class="card-body">
                            <h5 class="portfolio-title">Pack Office</h5>
                        </div>
                        <div class="card-tag d-none">EXCEL OFFICE</div>
                        <div class="card-footer">
                            <div><a class="tag-link" href="/argentina/a-pack-office/" target="_blank">Pack de conocimientos clave e infaltables en un Currículum. Dominá las 3 herramientas más solicitadas por las empresas.<br></a>
                                <a class="btn btn-lg btn-block" href="/argentina/a-pack-office/"
                                                                                                                                                                                                        target="_blank" style="background-color:#4eaf4e; color:white;">👉 Ver curso</a></div>
                        </div>
                    </div>
                    <!-- /div -->
                    <!-- div class="col-md-3 col-sm-6 mb-30 pb-2" -->
                    <div class="card portfolio-card col-md-3 col-sm-6 mb-30 pb-2"> <img src="assets/img/word.jpg" alt="Portfolio Thumbnail" style="">
                        <div class="card-body">
                            <h5 class="portfolio-title">Microsoft Word: curso completo</h5>
                        </div>
                        <div class="card-tag d-none">OFFICE</div>
                        <div class="card-footer">
                            <div><a class="tag-link" href="/argentina/a-word/" target="_blank"> Aprendé a dominar con facilidad el procesador de texto más utilizado del mundo: Microsoft Word. Sin requisitos previos<br> 
                                    <a class="btn btn-lg btn-block" href="/argentina/a-word" target="_blank" style="background-color:#4eaf4e; color:white;">👉 Ver Curso</a></div>
                        </div>
                    </div>
                    <!-- /div -->
                    <!-- div class="col-md-3 col-sm-6 mb-30 pb-2" -->
                    <div class="card portfolio-card col-md-3 col-sm-6 mb-30 pb-2"> <img src="assets/img/powerpoint.jpg" alt="Portfolio Thumbnail" style="">
                        <div class="card-body">
                            <h5 class="portfolio-title">Microsoft Power Point</h5>
                        </div>
                        <div class="card-tag d-none">OFFICE</div>
                        <div class="card-footer">
                            <div><a class="tag-link" href="/argentina/a-power-point/" target="_blank">Creá fácilmente presentaciones atractivas, cursos, diapositivas y mucho más. Sin requisitos previos <br></a>
                                <a class="btn btn-lg btn-block" href="/argentina/a-power-point/" target="_blank"
                                                                                                                                                                                                        style="background-color:#4eaf4e; color:white;">👉 Ver curso</a></div>
                        </div>
                    </div>
                    <!-- /div -->
                    <!-- div class="col-md-3 col-sm-6 mb-30 pb-2" -->
                    <div class="card portfolio-card col-md-3 col-sm-6 mb-30 pb-2"> <img src="assets/img/curso-visual-studio.jpg" alt="Portfolio Thumbnail" style="">
                        <div class="card-body">
                            <h5 class="portfolio-title">Programación en C# con Visual Studio</h5>
                        </div>
                        <div class="card-tag d-none">Programación</div>
                        <div class="card-footer">
                            <div><a class="tag-link" href="/argentina/a-visual-studio/" target="_blank">Iniciate en el mundo de la programación a través de este poderoso lenguaje<br></a>
                                <a class="btn btn-lg btn-block" href="/argentina/a-visual-studio/" target="_blank" style="background-color:#4eaf4e; color:white;">👉 Ver curso</a></div>
                        </div>
                    </div>
                    <!-- /div -->
                    <!-- div class="col-md-3 col-sm-6 mb-30 pb-2" -->
                    <div class="card portfolio-card col-md-3 col-sm-6 mb-30 pb-2"> <img src="assets/img/microsoft-project-bottom.jpg" alt="Portfolio Thumbnail" style="">
                        <div class="card-body">
                            <h5 class="portfolio-title">Microsoft Project Inicial</h5>
                        </div>
                        <div class="card-tag d-none">Gerencia de proyectos</div>
                        <div class="card-footer">
                            <div><a class="tag-link" href="/argentina/a-microsoft-project-inicial/" target="_blank">Iniciate en la administración y desarrollo de proyectos y escalá tu puesto laboral.<br></a>
                                <a class="btn btn-lg btn-block" href="/argentina/a-microsoft-project-inicial/"
                                                                                                                                                                                                        target="_blank" style="background-color:#4eaf4e; color:white;">👉 Ver curso</a></div>
                        </div>
                    </div>
                    <!-- /div -->
                    <!-- div class="col-md-3 col-sm-6 mb-30 pb-2" -->
                    <div class="card portfolio-card col-md-3 col-sm-6 mb-30 pb-2"> <img src="assets/img/microsoft-project-intermedios-top.jpg" alt="Portfolio Thumbnail" style="">
                        <div class="card-body">
                            <h5 class="portfolio-title">Microsoft Project Intermedio</h5>
                        </div>
                        <div class="card-tag d-none">Gerencia de proyectos</div>
                        <div class="card-footer">
                            <div><a class="tag-link" href="/argentina/a-microsoft-project-intermedio/" target="_blank">Se continúa en profundidad el nivel inicial<br></a>
                                <a class="btn btn-lg btn-block" href="/argentina/a-microsoft-project-intermedio/" target="_blank" style="background-color:#4eaf4e; color:white;">👉 Ver curso</a></div>
                        </div>
                    </div>
                    <!-- /div -->
                    <!-- div class="col-md-3 col-sm-6 mb-30 pb-2" -->
                    <div class="card portfolio-card col-md-3 col-sm-6 mb-30 pb-2"> <img src="assets/img/project-3.jpg" alt="Portfolio Thumbnail" style="">
                        <div class="card-body">
                            <h5 class="portfolio-title">Microsoft Project Avanzado</h5>
                        </div>
                        <div class="card-tag d-none">Gerencia de proyectos</div>
                        <div class="card-footer">
                            <div><a class="tag-link" href="/argentina/a-microsoft-project-avanzado/" target="_blank">Nivel 3 de Microsoft Project. Completá tus conocimientos y se todo un profesional de Microsoft Project.<br></a>
                                <a class="btn btn-lg btn-block" href="/argentina/a-microsoft-project-avanzado/"
                                                                                                                                                                                                        target="_blank" style="background-color:#4eaf4e; color:white;">👉 Ver curso</a></div>
                        </div>
                    </div>
                    <!-- /div -->
                    <!-- div class="col-md-3 col-sm-6 mb-30 pb-2" -->
                    <div class="card portfolio-card col-md-3 col-sm-6 mb-30 pb-2"> <img src="assets/img/sql.jpg" alt="Portfolio Thumbnail" style="">
                        <div class="card-body">
                            <h5 class="portfolio-title">Microsoft SQL Server</h5>
                        </div>
                        <div class="card-tag d-none">Programación</div>
                        <div class="card-footer">
                            <div><a class="tag-link" href="/argentina/a-microsoft-sql-server/" target="_blank">Aprendé a programar en base de datos desde cero. Recomendable para principiantes<br></a>
                                <a class="btn btn-lg btn-block" href="/argentina/a-microsoft-sql-server/" target="_blank"
                                                                                                                                                                                                  style="background-color:#4eaf4e; color:white;">👉 Ver curso</a></div>
                        </div>
                    </div>
                    <!-- /div -->
                    <!-- div class="col-md-3 col-sm-6 mb-30 pb-2" -->
                    <div class="card portfolio-card col-md-3 col-sm-6 mb-30 pb-2"> <img src="assets/img/ws-01.jpg" alt="Portfolio Thumbnail" style="">
                        <div class="card-body">
                            <h5 class="portfolio-title">Windows Server</h5>
                        </div>
                        <div class="card-tag d-none">Otros</div>
                        <div class="card-footer">
                            <div><a class="tag-link" href="/argentina/a-windows-server/" target="_blank">Aprendé de cero a cien cómo administrar servidores Windows.<br></a>
                                <a class="btn btn-lg btn-block" href="/argentina/a-windows-server/" target="_blank" style="background-color:#4eaf4e; color:white;">👉 Ver curso</a></div>
                        </div>
                    </div>
                    <!-- /div -->
                    <!-- div class="col-md-3 col-sm-6 mb-30 pb-2" -->
                    <div class="card portfolio-card col-md-3 col-sm-6 mb-30 pb-2"> <img src="assets/img/petroleo-01.jpg" alt="Portfolio Thumbnail" style="">
                        <div class="card-body">
                            <h5 class="portfolio-title">Introducción al Petróleo</h5>
                        </div>
                        <div class="card-tag d-none">Petroleo Otros</div>
                        <div class="card-footer">
                            <div><a class="tag-link" href="/argentina/a-petroleo/" target="_blank">Incursioná en el mundo petrolero. Con este curso introductorio vas a tener una base inicial para aplicar en empleos de la industria petrolera.<br></a>
                                <a class="btn btn-lg btn-block" href="/argentina/a-petroleo/" target="_blank" style="background-color:#4eaf4e; color:white;">👉 Ver curso</a></div>
                        </div>
                    </div>
                    <!-- /div -->
                    <!-- div class="col-md-3 col-sm-6 mb-30 pb-2" -->
                    <div class="card portfolio-card col-md-3 col-sm-6 mb-30 pb-2"> <img src="assets/img/pack-power-bi-y-excel.jpg" alt="Portfolio Thumbnail" style="">
                        <div class="card-body">
                            <h5 class="portfolio-title">Pack Experto en Excel + Power BI</h5>
                        </div>
                        <div class="card-tag d-none">Excel Power BI</div>
                        <div class="card-footer">
                            <div><a class="tag-link" href="/argentina/a-power-bi-y-excel/" target="_blank">Convertite en el Experto/a que las empresas necesitan, aprendiendo los 3 niveles de Excel y Power BI<br></a>
                                <a class="btn btn-lg btn-block" href="/argentina/a-power-bi-y-excel/" target="_blank"
                                                                                                                                                                                                        style="background-color:#4eaf4e; color:white;">👉 Ver curso</a></div>
                        </div>
                    </div>
                    <!-- /div -->
                    <!-- div class="col-md-3 col-sm-6 mb-30 pb-2" -->
                    <div class="card portfolio-card col-md-3 col-sm-6 mb-30 pb-2"> <img src="/assets/img/ms-project/6.jpg" alt="Portfolio Thumbnail" style="">
                        <div class="card-body">
                            <h5 class="portfolio-title">Pack Experto Ms Project</h5>
                        </div>
                        <div class="card-tag d-none">Gerencia de proyectos</div>
                        <div class="card-footer">
                            <div><a class="tag-link" href="/argentina/a-pack-project/" target="_blank">Aprendiendo los 3 niveles de Microsoft Project vas a poder administrar todos los proyectos que te propongas como un experto.<br></a>
                                <a class="btn btn-lg btn-block" href="/argentina/a-pack-project/"
                                                                                                                                                                                                        target="_blank" style="background-color:#4eaf4e; color:white;">👉 Ver curso</a></div>
                        </div>
                    </div>
                    <!-- /div -->
        ...
        <hr>
        <section class="py-5 " style="	background-color: #;	background-image: url(&quot;assets/img/fondo3.jpg&quot;);	background-position: top left;	background-size: 100%;	background-repeat: no-repeat;" id="">
            <div class="container-fluid">
                <div class="row align-items-center">
                    <div class="col-xl-5 col-md-6 offset-xl-1"><img class="d-block mx-auto img-thumb border rounded img-thumbnail" src="assets/img/empresa.jpg" alt="CreateX Marketing"></div>
                    <div class="col-xl-5 col-md-6 text-center text-md-left py-5" style="">
                        ...
                        <a class="" target="_blank" href="https://aprende-excel.com/plan-empresa/"> <img class="img-fluid d-block mx-auto mx-md-1" src="assets/img/whatsappempresas.png"></a>
                    </div>
                </div>
            </div>
        </section>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 p-3">
                        <div class="card">
                            <div class="card-body p-4">
                                <div class="row">
                                    <div class="col-md-4 col-3"> <img class="img-fluid d-block rounded-circle" src="assets/img/testimonios/belen.jpg"> </div>
                                    <div class="d-flex  col-md-8 flex-column justify-content-center align-items-start col-9">
                                        <p class="mb-0 lead"><b>Belén</b></p>
                                        <p class="mb-0">Ciudad de Buenos Aires </p><img class="img-fluid d-block" src="assets/img/45star.png">
                                    </div>
                                </div>
                    ...
                    <div class="col-lg-4 col-md-6 p-3">
                        <div class="card">
                            <div class="card-body p-4">
                                <div class="row">
                                    <div class="col-md-4 col-3"> <img class="img-fluid d-block rounded-circle" src="assets/img/testimonios/federico.jpg"> </div>
                                    <div class="d-flex  col-md-8 flex-column justify-content-center align-items-start col-9">
                                        <p class="mb-0 lead"><b>Federico</b></p>
                                        <p class="mb-0">Misiones</p><img class="img-fluid d-block" src="assets/img/45star.png">
                                    </div>
                                </div>
                    ...
                    <div class="col-lg-4 p-3">
                        <div class="card">
                            <div class="card-body p-4">
                                <div class="row">
                                    <div class="col-md-4 col-3"> <img class="img-fluid d-block rounded-circle" src="assets/img/testimonios/ramiro.jpg"> </div>
                                    <div class="d-flex  col-md-8 flex-column justify-content-center align-items-start col-9">
                                        <p class="mb-0 lead"><b>Ramiro</b></p>
                                        <p class="mb-0">San Miguel de Tucumán</p><img class="img-fluid d-block" src="assets/img/5star.png">
                                    </div>
                                </div>
                    ...
                    <div class="col-lg-4 col-md-6 p-3">
                        <div class="card">
                            <div class="card-body p-4">
                                <div class="row">
                                    <div class="col-md-4 col-3"> <img class="img-fluid d-block rounded-circle" src="assets/img/testimonios/daniel.jpg"> </div>
                                    <div class="d-flex  col-md-8 flex-column justify-content-center align-items-start col-9">
                                        <p class="mb-0 lead"><b>Daniel</b></p>
                                        <p class="mb-0">Ciudad de Córdoba</p><img class="img-fluid d-block" src="assets/img/45star.png">
                                    </div>
                                </div>
                    ...
                    <div class="col-lg-4 col-md-6 p-3">
                        <div class="card">
                            <div class="card-body p-4">
                                <div class="row">
                                    <div class="col-md-4 col-3"> <img class="img-fluid d-block rounded-circle" src="assets/img/testimonios/laura.jpg"> </div>
                                    <div class="d-flex  col-md-8 flex-column justify-content-center align-items-start col-9">
                                        <p class="mb-0 lead"><b>Laura</b></p>
                                        <p class="mb-0">Ciudad de Buenos Aires </p><img class="img-fluid d-block" src="assets/img/5star.png">
                                    </div>
                                </div>
                    ...
                    <div class="col-lg-4 col-md-6 p-3">
                        <div class="card">
                            <div class="card-body p-4">
                                <div class="row">
                                    <div class="col-md-4 col-3"> <img class="img-fluid d-block rounded-circle" src="assets/img/testimonios/alejandro.jpg"> </div>
                                    <div class="d-flex  col-md-8 flex-column justify-content-center align-items-start col-9">
                                        <p class="mb-0 lead"><b>Alejandro</b></p>
                                        <p class="mb-0">Provincia de Buenos Aires</p><img class="img-fluid d-block" src="assets/img/5star.png">
                                    </div>
                                </div>
        ...
        <div class="py-5 text-center">
            <div class="container">
                ...
                <div class="row text-center">
                    ...
                    <div class="col-md-4 text-center">
                        <a class="" target="_blank" href="https://api.whatsapp.com/send?phone=5491168787291&amp;text=Hola!%20Te%20escribo%20por%20el%20curso%20de%20Excel"> <img class="img-fluid d-block  mx-auto" src="assets/img/whatsapp.jpg"> </a>
                    </div>
                    <div class="col-md-4 text-center">
                    </div>
                </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 pb-4 pt-5 mb-2">
                        <a class="navbar-brand d-inline-block mb-4" href=""><img src="assets/img/logojpg.jpg" alt="CreateX"></a>
                        <ul class="list-icon text-sm pb-2" style="">
                            ...
                            <li><i class="fe-icon-mail text-muted"></i><a class="navi-link" href="mailto:hola@excel-facil.com">hola@excel-facil.com</a></li>
                        </ul>
        ...
        <!-- div class="text-center cookiealert" role="alert" id="popup">
            <div class="container">
                <div class="row">
                    <div>
                        <img class="logoban " src="assets/img/logojpg.jpg" style="min-width: 77px;">
                        ...
                        <img class="logoban" src="assets/img/15off_etiqueta.png" style="min-width: 77px;" />
