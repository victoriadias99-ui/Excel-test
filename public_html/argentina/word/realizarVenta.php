...
try {   
	...
	$preference->notification_url = "https://excel-facil.com/word/IPN_mp.php?curso=$curso";
  ...
  "excluded_payment_types" => array(array("id" => "ticket")));
    ...
    "success" => "https://excel-facil.com/word/pago_exitoso.html",
    "failure" => "https://excel-facil.com/word/pago_en_proceso.html",
    "pending" => "https://excel-facil.com/word/pago_en_proceso.html");
