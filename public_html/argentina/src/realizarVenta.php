...
$datos = array('google_sheet' => array (
									
											'url_exitoso' => '/google-sheets/pago_exitoso.html' ,
											'url_failure' => '/google-sheets/checkout.html',
											'url_pending' =>'/google-sheets/checkout.html'
										),
				'up_sell_pbi_sheet' =>array(
	
											'url_exitoso' => '/google-sheets/pago_exitoso_1y2.html' ,
											'url_failure' => '/google-sheets/checkout.html',
											'url_pending' =>'/google-sheets/checkout.html'
											)	
				); 

$url_base = 'https://excel-facil.com';
...
try {   
  ...
  "excluded_payment_types" => array(array("id" => "ticket")));
    	...
    	"success" => $url_base.$datos[$curso]['url_exitoso'],
    	"failure" => $url_base.$datos[$curso]['url_failure'],
		"pending" => $url_base.$datos[$curso]['url_pending']
		);
