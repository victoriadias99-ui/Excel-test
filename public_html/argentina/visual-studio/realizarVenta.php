...
try {   
	...
	$preference->notification_url = "https://excel-facil.com/visual-studio/IPN_mp.php?curso=$curso";
	$preference->payment_methods = array(
  "excluded_payment_methods" => array(array("id" => "rapipago"),array("id" => "pagofacil")),
  "excluded_payment_types" => array(array("id" => "ticket")));
	  if($curso == 'visualstudio')
	{
		$preference->back_urls = array(
    "success" => "https://excel-facil.com/visual-studio/pago_exitoso.html",
    "failure" => "https://excel-facil.com/visual-studio/pago_en_proceso.html",
    "pending" => "https://excel-facil.com/visual-studio/pago_en_proceso.html");
	}
	
	if($curso == 'upsell_visual_y_pbi')
	{
		$preference->back_urls = array(
        "success" => "https://excel-facil.com/visual-studio/pago_exitoso_up.html",
        "failure" => "https://excel-facil.com/visual-studio/pago_en_proceso.html",
        "pending" => "https://excel-facil.com/visual-studio/pago_en_proceso.html");
	}
