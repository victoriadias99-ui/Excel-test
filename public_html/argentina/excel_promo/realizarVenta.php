...
try {   
	...
	$item->picture_url = "https://excel-facil.com/excel_promo/img/logojpg.jpg";
	...
	if(count($rows_descuento)>0)
	{
		...
		$itemdesc->picture_url = "https://excel-facil.com/excel_promo/img/logojpg.jpg";		
	...
	$preference->notification_url = "https://excel-facil.com/excel_promo/IPN_mp.php?curso=$curso";
  ...
  "excluded_payment_types" => array(array("id" => "ticket")));
    ...
    "success" => "https://excel-facil.com/excel_promo/pago_exitoso.html",
    "failure" => "https://excel-facil.com/excel_promo/pago_en_proceso_2.html",
    "pending" => "https://excel-facil.com/excel_promo/pago_en_proceso_2.html");
