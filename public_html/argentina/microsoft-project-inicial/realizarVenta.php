...
try {   
  ...
  "excluded_payment_types" => array(array("id" => "ticket")));
	if($curso == 'project')
	{
    	...
    	"success" => "https://excel-facil.com/microsoft-project-inicial/pago_exitoso.html",
    	"failure" => "https://excel-facil.com/microsoft-project-inicial/checkout.html",
    	"pending" => "https://excel-facil.com/microsoft-project-inicial/checkout.html");
	}
	
	if($curso == 'upsell_project_intermedio')
	{
		$preference->back_urls = array(
    	"success" => "https://excel-facil.com/microsoft-project-inicial/pago_exitoso_1y2.html",
    	"failure" => "https://excel-facil.com/microsoft-project-inicial/checkout.html",
    	"pending" => "https://excel-facil.com/microsoft-project-inicial/checkout.html");
	}
	...
	{
		$preference->back_urls = array(
    	"success" => "https://excel-facil.com/microsoft-project-inicial/pago_exitoso_1y3.html",
    	"failure" => "https://excel-facil.com/microsoft-project-inicial/checkout.html",
    	"pending" => "https://excel-facil.com/microsoft-project-inicial/checkout.html");
	}
	...
	{
		$preference->back_urls = array(
    	"success" => "https://excel-facil.com/microsoft-project-inicial/pago_exitoso_1y2y3.html",
    	"failure" => "https://excel-facil.com/microsoft-project-inicial/checkout.html",
    	"pending" => "https://excel-facil.com/microsoft-project-inicial/checkout.html");
	}
