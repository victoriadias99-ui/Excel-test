...
try {   
	...
	$item->picture_url = "https://excel-facil.com/excel-inicial/img/logojpg.jpg";
	...
	if(count($rows_descuento)>0)
	{
		...
		$itemdesc->picture_url = "https://excel-facil.com/excel-inicial/img/logojpg.jpg";		
	...
	$preference->notification_url = "https://excel-facil.com/excel-inicial/IPN_mp.php?curso=$curso";
  ...
  "excluded_payment_types" => array(array("id" => "ticket")));
	if($curso == 'excel')
	{
    	...
    	"success" => "https://excel-facil.com/excel-inicial/pago_exitoso.html",
    	"failure" => "https://excel-facil.com/excel-inicial/pago_en_proceso_2.html",
    	"pending" => "https://excel-facil.com/excel-inicial/pago_en_proceso_2.html");
	}
	
	if($curso == 'upsell_inicial_y_intermedio')
	{
		$preference->back_urls = array(
    	"success" => "https://excel-facil.com/excel-inicial/pago_exitoso_1y2.html",
    	"failure" => "https://excel-facil.com/excel-inicial/pago_en_proceso_1y2.html",
    	"pending" => "https://excel-facil.com/excel-inicial/pago_en_proceso_1y2.html");
	}
