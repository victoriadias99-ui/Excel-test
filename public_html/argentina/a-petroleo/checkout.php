    ...
    <div class="container">
      <div class="row">
        ...
        <div class="px-md-5 p-3 d-flex flex-column align-items-start justify-content-center col-md-7 order-1 order-md-2" style="">
           <h3 class="mb-3 titulos sombras">Introducite en el mercado laboral petrolero!</h3>
      ...
      <div class="row">
        <div class="col-md-6 order-md-2 px-0 px-md-4" style="padding: 80px 20px 20px;">
          ...
          <div class=" col-md-12 mt-5" style="">
            <div class=" mb-0">
              <p>"Me pareció muy completo y bien transmitido. Vivo en Neuquén y me sirve para empezar a aplicar a las empresas del rubro que hay acá."</p>
              ...
              <div class="blockquote-footer">
                <b>Emanuel Artiaga</b></div>
            </div>
          </div>
          <div class=" col-md-12 mt-5" style="">
            <div class=" mb-0">
              <p>"El curso esta muy bien. Trabajo con informática y siempre quise ingresar en el mundo petrolero, lo recomiendo además está a muy buen precio."</p>
              <div class="rating-user d-inline">
                <i class="fa fa-star"></i>
                <i class="fa fa-star"></i>
                <i class="fa fa-star"></i>
...
<?php
          ...
          <ul class="list-group mt-4">
            <li class="list-group-item d-flex justify-content-between">
              <div>
                <h6 class="my-0"><b>Introducción al Petróleo</b></h6> <small class="text-muted">Acceso de por vida</small>
  ...
  <div class="py-5 text-center">
    <div class="container">
      ...
      <div class="row text-center">
        ...
        <div class="col-md-4 text-center">
          <a class="" href="https://api.whatsapp.com/send?phone=5491168787291amp;text=Hola!%20Te%20escribo%20por%20el%20curso%20de%20Petroleo"> <img class="img-fluid d-block  mx-auto" src="img/whatsapp.jpg"> </a>
        </div>
        <div class="col-md-4 text-center">
        </div>
      </div>
