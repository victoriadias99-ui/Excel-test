...
try {   
  ...
  "excluded_payment_types" => array(array("id" => "ticket")));
	if($curso == 'petroleo')
	{
    	...
    	"success" => "https://excel-facil.com/petroleo/pago_exitoso.html",
    	"failure" => "https://excel-facil.com/petroleo/checkout.html",
    	"pending" => "https://excel-facil.com/petroleo/checkout.html");
	}
	if($curso == 'upsell_petroleo_pbi')
	{
		$preference->back_urls = array(
    	"success" => "https://excel-facil.com/petroleo/pago_exitoso_1y2.html",
    	"failure" => "https://excel-facil.com/petroleo/checkout.html",
    	"pending" => "https://excel-facil.com/petroleo/checkout.html");
	}
