...
try {   
	...
	$item->picture_url = "https://excel-facil.com/curso1/img/logojpg.jpg";
	...
	if(count($rows_descuento)>0)
	{
		...
		$itemdesc->picture_url = "https://excel-facil.com/curso1/img/logojpg.jpg";		
	...
	$preference->notification_url = "https://excel-facil.com/microsoft-project-inicial/IPN_mp.php?curso=$curso";
	$preference->payment_methods = array(
  "excluded_payment_methods" => array(array("id" => "rapipago"),array("id" => "pagofacil")),
  "excluded_payment_types" => array(array("id" => "ticket")));
	if($curso == 'project_intermedio')
	{
		$preference->back_urls = array(
    	"success" => "https://excel-facil.com/microsoft-project-intermedio/pago_exitoso.html",
    	"failure" => "https://excel-facil.com/microsoft-project-intermedio/checkout.html",
    	"pending" => "https://excel-facil.com/microsoft-project-intermedio/checkout.html");
	}
	
	if($curso == 'upsell_project_intermedio')
	{
		$preference->back_urls = array(
    	"success" => "https://excel-facil.com/microsoft-project-intermedio/pago_exitoso_1y2.html",
    	"failure" => "https://excel-facil.com/microsoft-project-intermedio/checkout.html",
    	"pending" => "https://excel-facil.com/microsoft-project-intermedio/checkout.html");
	}
	if($curso == 'upsell_p_intermedio_avan')
	{
		$preference->back_urls = array(
    	"success" => "https://excel-facil.com/microsoft-project-intermedio/pago_exitoso_2y3.html",
    	"failure" => "https://excel-facil.com/microsoft-project-intermedio/checkout.html",
    	"pending" => "https://excel-facil.com/microsoft-project-intermedio/checkout.html");
	}
	if($curso == 'upsell_project_intermedio_avan')
	{
		$preference->back_urls = array(
    	"success" => "https://excel-facil.com/microsoft-project-intermedio/pago_exitoso_1y2y3.html",
    	"failure" => "https://excel-facil.com/microsoft-project-intermedio/checkout.html",
    	"pending" => "https://excel-facil.com/microsoft-project-intermedio/checkout.html");
	}
