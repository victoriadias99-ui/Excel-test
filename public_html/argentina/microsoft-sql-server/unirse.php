    ...
    <div class="container">
      <div class="row justify-content-center align-items-center">
        ...
        <div class="col-md-6">
          ...
          /*  ***** cambios ******/ 
          foreach($rg as $r): ?>
          <a class="btn btn-block btn-lg py-4 btn-outline-light" target="_blank" style="background-color:#e6007e;" href="<?php echo $url_grupos[$r][0]?>"><b>EMPEZAR EL CURSO <?php echo $url_grupos[$r][1]?>&nbsp;</b>👉</a>
