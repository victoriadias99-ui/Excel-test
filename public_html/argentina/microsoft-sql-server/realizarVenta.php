...
try {   
  ...
  "excluded_payment_types" => array(array("id" => "ticket")));
	if($curso == 'sql')
	{
    	...
    	"success" => "https://excel-facil.com/ms-sql/pago_exitoso.html",
    	"failure" => "https://excel-facil.com/ms-sql/checkout.html",
    	"pending" => "https://excel-facil.com/ms-sql/checkout.html");
	}
	
	if($curso == 'upsell_sql_powerbi')
	{
		$preference->back_urls = array(
    	"success" => "https://excel-facil.com/ms-sql/pago_exitoso_1y2.html",
    	"failure" => "https://excel-facil.com/ms-sql/checkout.html",
    	"pending" => "https://excel-facil.com/ms-sql/checkout.html");
	}
