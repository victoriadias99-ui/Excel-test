...
try {   
	...
	$preference->notification_url = "https://excel-facil.com/windows-server/IPN_mp.php?curso=$curso";
	$preference->payment_methods = array(
  "excluded_payment_methods" => array(array("id" => "rapipago"),array("id" => "pagofacil")),
  "excluded_payment_types" => array(array("id" => "ticket")));
	if($curso == 'windows_server')
	{
		$preference->back_urls = array(
    	"success" => "https://excel-facil.com/windows-server/pago_exitoso.html",
    	"failure" => "https://excel-facil.com/windows-server/checkout.html",
    	"pending" => "https://excel-facil.com/windows-server/checkout.html");
	}
	
	if($curso == 'upsell_wserver_sql')
	{
		$preference->back_urls = array(
		"success" => "https://excel-facil.com/windows-server/pago_exitoso_1y2.html",
    	"failure" => "https://excel-facil.com/windows-server/checkout.html",
    	"pending" => "https://excel-facil.com/windows-server/checkout.html");
	}
