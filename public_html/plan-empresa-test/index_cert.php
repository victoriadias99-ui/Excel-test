        ...
        <div class="pop-up-wrap">
            ...
            <div class="subcription">
                ...
                <div class="sub-content">
                    ...
                    <form>
                        <input type="email" class="subs-email" placeholder="Esccribe tu correo electronico">
        ...
        <section>
            <div class="row">
                <div class="col-md-7 px-5 ">
                    ...
                    <h5 class="mt-4" style="font-family: 'Raleway Bold';color: #00173B;">Capacita a tu personal para que mejoren hasta un 70% en su trabajo</h5>
                    ...
                    <p class="item-sec2"><img src="assets/img/icono-s2-1.png">&nbsp; Planes personalizados. Acorde a la necesidad de cada empleado.</p>
                                ...
                                <input type="text" class="form-control form-control-md" placeholder="Tu Nombre" name="nombre" required=""> </div>
                                    ...
                                    <input type="text" class="form-control form-control-md" placeholder="Tu celular (+cód de área)" name="telefono" required=""> </div>
                                        ...
                                        <input type="text" class="form-control form-control-md" placeholder="Empresa" name="empresa" required=""> </div>
                                            ...
                                            <textarea class="form-control " name="comentario" id="contacto" placeholder="Comentarios" maxlength="25" rows="3"></textarea>
                                            </div>
                ...
                <div class="d-none d-md-block col-md-5 position-relative">
                    <div class="card-madre px-3 py-4 mr-5" style="position: fixed; border-radius: 10px;box-shadow: 10px 10px 20px 14px rgb(205,205,205);background: #ffffff;">
                        <div class="col">
                            <h5 style="color: #00173B;font-family: 'Raleway SemiBold';"><img src="assets/img/imagen-porcentaje.png" style="width: 50px;">&nbsp;Accede hoy</h5>
                            <p class="text-center">
                                <a href="<?= $urlCheckout ?>" class="btn btn-primary px-5" style="background: #007A6A;width: 80%;">Solicitar más información</a>
                            </p>
                            <ul class="lista-header pl-3" style="list-style-type: none;">
                                ...
                                <li style="font-size:14px;"><i class="fa fa-check" style="color: #008B69;"></i>&nbsp;Otorgamos Certificado Internacional<br></li>
                            </ul>
                        </div>
                    </div>
