...
<html>
    ...
    <body style="font-family:montserrat_regular">
        ...
        <div class="pt-5">
            <div class="container">
                <div class="row">
                    <div class="col-md-4  mr-auto order-2 order-md-1"> <img class="img-fluid d-block" src="img/microsoft-project-intermedios-bottom.jpg"> </div>
                ...
                <div class="row">
                    <div class="col-md-6 order-md-2 px-0 px-md-4" style="padding: 80px 20px 20px;">
                        ...
                        <div class=" col-md-12 mt-5" style="">
                            <div class=" mb-0">
                                <p>"Ideal para planificación de proyectos"</p>
                                ...
                                <div class="blockquote-footer">
                                    <b>Mauro Ferrero</b>, Cordoba</div>
                            </div>
                        </div>
                        <div class=" col-md-12 mt-5" style="">
                            <div class=" mb-0">
                                <p>"Excelente el profesor explica muy bien, termino y sigo con el avanzado!"</p>
                                <div class="rating-user d-inline">
                                    <i class="fa fa-star"></i>
                                    <i class="fa fa-star"></i>
                                    <i class="fa fa-star"></i>
                                ...
                                <div class="blockquote-footer">
                                    <b>Maxi Diaz</b>, Buenos Aires</div>
                            </div>
                        </div>
                    ...
                    <div class="order-md-2 border rounded bg-light my-5 py-5 px-md-4 col-md-5" style="">
                        ...
                        <ul class="list-group mt-4">
                            <li class="list-group-item d-flex justify-content-between">
                                <div>
                                    <h6 class="my-0"><b>Project nivel Intermedio</b></h6> <small class="text-muted">Acceso de por vida</small>
        ...
        <div class="py-5 text-center">
            <div class="container">
                ...
                <div class="row text-center">
                    ...
                    <div class="col-md-4 text-center">
                        <a class="" href="https://api.whatsapp.com/send?phone=5491168787291&amp;text=Hola!%20Te%20escribo%20por%20el%20curso%20de%20Project%20Intermedio"> <img class="img-fluid d-block  mx-auto" src="img/whatsapp.jpg"> </a>
                    </div>
                    <div class="col-md-4 text-center">
                    </div>
                </div>
