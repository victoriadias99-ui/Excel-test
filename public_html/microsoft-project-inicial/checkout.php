...
<html>
    ...
    <body style="font-family:montserrat_regular">
        ...
        <div class="pt-5">
            <div class="container">
                <div class="row">
                    <div class="col-md-4  mr-auto order-2 order-md-1"> <img class="img-fluid d-block" src="img/microsoft-project-top.jpg"> </div>
                    ...
                    <div class="order-md-2 border rounded bg-light my-5 py-5 px-md-4 col-md-5" style="">
                        ...
                        <ul class="list-group mt-4">
                            <li class="list-group-item d-flex justify-content-between">
                                <div>
                                    <h6 class="my-0"><b>Project nivel Inicial</b></h6> <small class="text-muted">Acceso de por vida</small>
        ...
        <div class="py-5 text-center">
            <div class="container">
                ...
                <div class="row text-center">
                    ...
                    <div class="col-md-4 text-center">
                        <a class="" href="https://api.whatsapp.com/send?phone=5491168787291&amp;text=Hola!%20Te%20escribo%20por%20el%20curso%20de%20Project%20Inicial"> <img class="img-fluid d-block  mx-auto" src="img/whatsapp.jpg"> </a>
                    </div>
                    <div class="col-md-4 text-center">
                    </div>
                </div>
