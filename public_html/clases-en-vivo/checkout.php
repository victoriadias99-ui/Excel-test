            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="px-md-5 p-3 d-flex flex-column align-items-start justify-content-center col-md-7 order-1 order-md-2" style="">
                        <h1 class="font-weight-bold">Aprende Excel - Clases en vivo</h1>
            ...
            <div class="container  px-0 px-md-4" style="">
                <div class="row p-3">
                    <div class="col-md-6 order-md-2 px-0 px-md-4" style="padding: 80px 20px 20px;">
                        ...
                        <p class="mb-3   mt-4"> Al abonar te vamos a enviar el link del zoom. Podes conectarte en tu PC, notebook, tablet o celular. ¡Es muy sencillo! </p>
                        <hr>
...
<li><i class="fas fa-check-square " style="color:#009045;"></i> Certificación Internacional</li>
                    ...
                    <div class="order-md-2 border rounded bg-light my-5 py-5 px-md-4 col-md-5" style="">
                        ...
                        <ul class="list-group">
                            <li class="list-group-item d-flex justify-content-between">
                                <div>
                                    <h6 class="my-0"><b>Clases en vivo</b></h6> <small class="text-muted">Acceso de por vida</small>
                        ...
                        <div class="order-md-2 mx-3" style="">
                            <div class="row border rounded py-4 bg-white">
                                <h4 class="mx-auto mt-3 pb-3 text-center">¿Dónde querés recibir la información?</h4>
            ...
            <div class="py-5 text-center text-dark mt-5">
                ...
                <div class="container">
                    ...
                    <div class="row text-center">
                        ...
                        <div class="col-md-4 text-center">
                            <a class="" href="https://api.whatsapp.com/send?phone=5491168787291&amp;text=Hola!%20Te%20escribo%20por%20el%20curso%20de%20Excel%20vivo" target="_blank"> <img class="img-fluid d-block  mx-auto" src="../n-img/whatsapp_.jpg"> </a>
                        </div>
                        <div class="col-md-4 text-center">
                        </div>
                    </div>
