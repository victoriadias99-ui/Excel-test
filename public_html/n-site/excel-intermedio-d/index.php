        ...
        <section>
            <div class="row">
                <div class="col-md-7 px-5 ">
                    <img class="d-block d-md-none img-fluid mb-4" src="../n-img/c-excelintermedio.jpeg" width="100%">
                    <h5 class="texto-header">4.9/5&nbsp;<i class="fa fa-star" style="color: #F7AC3B;"></i>&nbsp;Basado en 15.000 estudiantes</h5>
                    <h1 style="font-family: 'Raleway Black'; color:#00173B;">Nivel Intermedio Excel</h1>
                    <h5 class="mt-4" style="font-family: 'Raleway Bold';color: #00173B;">Dominá Excel en profundidad</h5>
                    ...
                    <div class="d-block d-md-none mt-3">
                        ...
                        <p class="mt-4" style="color: rgb(85,85,85);font-family: 'Raleway Regular';">Aprende Excel en solo 4 horas con ejemplos reales y soporte siempre que lo necesites</p>
                    
                        <ul class="lista-header pl-3" style="list-style-type: none;">
                                <li><i class="fa fa-check" style="color: #008B69;"></i>&nbsp;4hs de video paso a paso<br></li>
                    ...
                    <img class="d-none d-md-block img-fluid mt-2" src="../n-img/c-excelintermedio.jpeg" width="100%">
                    <p class="d-none d-md-block mt-4" style="color: rgb(85,85,85);font-family: 'Raleway Regular';">Aprende Excel en solo 4 horas con ejemplos reales y soporte siempre que lo necesites</p>
                    ...
                    <ul class="lista-header pl-3 mt-2" style="list-style-type: none;">
                        ...
                        <li><i class="fa fa-check" style="color: #008B69;"></i>&nbsp; Crear plantillas para gráficos<br></li>
                        <li><i class="fa fa-check" style="color: #008B69;"></i>&nbsp; Filtros avanzados<br></li>
                        <li><i class="fa fa-check" style="color: #008B69;"></i>&nbsp; Funciones avanzadas<br></li>
                        <li><i class="fa fa-check" style="color: #008B69;"></i>&nbsp; Creación de paneles/dashboards<br></li>
                        <li><i class="fa fa-check" style="color: #008B69;"></i>&nbsp; Ejecutar y automatizar Macros<br></li>
                        <li><i class="fa fa-check" style="color: #008B69;"></i>&nbsp; Casos prácticos<br></li>
                        <li><i class="fa fa-check" style="color: #008B69;"></i>&nbsp;y muchísimo mas!<br></li>
                        <li>Requisitos: conocimientos básicos de Excel (si no los tenés, debés comenzar por nuestro curso Nivel Inicial)</li>
                    </ul>
            ...
            <div class="row px-3 px-md-5" style="background: linear-gradient(90deg, #007a6a, #008c69 71%, #5e892b 100%);">
                <div class="d-xl-flex align-items-xl-center col-md-6 p-5">
                    <div>
                        ...
                        <h1 style="font-family: 'Raleway Black';color: rgb(255,255,255);">Excel Intermedio</h1>
