        ...
        <section>
            <div class="row">
                <div class="col-md-7 px-5 ">
                    <img class="d-block d-md-none img-fluid mb-4" src="../n-img/imagen-excel-nuevo.jpeg" width="100%">
                    <h5 class="texto-header">4.9/5&nbsp;<i class="fa fa-star" style="color: #F7AC3B;"></i>&nbsp;Basado en 15.000 estudiantes</h5>
                    <h1 style="font-family: 'Raleway Black'; color:#00173B;">Nivel Inicial Excel</h1>
                    <h5 class="mt-4" style="font-family: 'Raleway Bold';color: #00173B;">Abrí tus puertas en el mercado laboral</h5>
                    ...
                    <div class="d-block d-md-none mt-3">
                        ...
                        <p class="text-center">
                            <a href="<?= $urlCheckout ?>" class="btn btn-primary px-5" style="background: #007A6A;width: 100%;"><b>Quiero este curso</b></a>
                        </p>

                        <p class="mt-4" style="color: rgb(85,85,85);font-family: 'Raleway Regular';">Aprende Excel en solo 3 horas con ejemplos reales y soporte siempre que lo necesites</p>

                        <ul class="lista-header pl-3" style="list-style-type: none;">
                            <li><i class="fa fa-check" style="color: #008B69;"></i>&nbsp;Hacelo a tu propio ritmo, donde y cuando quieras<br></li>
                            <li><i class="fa fa-check" style="color: #008B69;"></i>&nbsp;Consultá cualquier duda 24/7<br></li>
                    ...
                    <img class="d-none d-md-block img-fluid mt-2" src="../n-img/imagen-excel-nuevo.jpeg" width="100%">

                    <p class="d-none d-md-block mt-4" style="color: rgb(85,85,85);font-family: 'Raleway Regular';">Aprende Excel en solo 3 horas con ejemplos reales y soporte siempre que lo necesites</p>
                    ...
                    <p class="item-sec2"><img src="assets/img/icono-s2-1.png">&nbsp; 3 horas de contenido para verlos donde y cuando quieras.</p>
                    ...
                    <ul class="lista-header pl-3 mt-2" style="list-style-type: none;">
                        <li><i class="fa fa-check" style="color: #008B69;"></i>&nbsp;Conocé los fundamentos de Microsoft Excel.<br></li>
                        <li><i class="fa fa-check" style="color: #008B69;"></i>&nbsp;Dominá las funciones básicas de Excel<br></li>
                        <li><i class="fa fa-check" style="color: #008B69;"></i>&nbsp;Aplicá funciones en distintos contextos<br></li>
                        <li><i class="fa fa-check" style="color: #008B69;"></i>&nbsp;Creá planillas de cálculo de forma sencilla<br></li>
                        <li><i class="fa fa-check" style="color: #008B69;"></i>&nbsp;Gestionar volúmenes de información de manera simple<br></li>
                        <li><i class="fa fa-check" style="color: #008B69;"></i>&nbsp;Utilizar filtros básicos y avanzados para el manejo de información<br></li>
                        <li><i class="fa fa-check" style="color: #008B69;"></i>&nbsp;Aplicá subtotales o totales parciales<br></li>
                        <li><i class="fa fa-check" style="color: #008B69;"></i>&nbsp;Gestioná la información de manera inteligente y fácil<br></li>
                        <li><i class="fa fa-check" style="color: #008B69;"></i>&nbsp;Controlá la administración y creá facturas.<br></li>
                    ...
                    <div class="accordion mt-4" id="accordionExample">
                        <div class="card">
                            <div class="card-header" id="headingOne">
                                <h5 class="mb-0"><button class="btn btn-link" type="button" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">#1 ¿Cuánto tiempo tengo para hacer el curso?</button></h5>
                            </div>
            ...
            <div class="row mt-3 mb-0">
                ...
                <div class="d-xl-flex align-items-xl-center col-md-6 p-5 pr-md-5">
                    <div>
                        <h4 style="font-family: 'Raleway Black';">Más de 15.500 alumnos de todo el país han aprendido con nuestro Curso Online a utilizar Excel para mejorar sus oportunidades.</h4>
                        ...
                        <a href="<?= $urlCheckout ?>" class="btn btn-primary px-5 ml-0" style="background: #007A6A;">Quiero este curso</a>
                    </div>
                </div>
            </div>
            <div class="row px-3 px-md-5" style="background: linear-gradient(90deg, #007a6a, #008c69 71%, #5e892b 100%);">
                <div class="d-xl-flex align-items-xl-center col-md-6 p-5">
                    <div>
                        <p style="color: rgb(255,255,255);">Adqurí un conocimiento clave en 3hs<br></p>
                        <h1 style="font-family: 'Raleway Black';color: rgb(255,255,255);">Excel Inicial</h1>
